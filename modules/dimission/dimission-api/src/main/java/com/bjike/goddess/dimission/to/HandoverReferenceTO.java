...
public class HandoverReferenceTO extends BaseTO {
     ...
     * 当前工作范围
     */
    @NotNull(message = "当前工作范围不能为空", groups = {ADD.class, EDIT.class})
    private String cycle;

    /**
     * 当前工作目的
     */
    @NotNull(message = "当前工作目的不能为空", groups = {ADD.class, EDIT.class})
    private String purpose;

    /**
     * 当前工作范围的权限
     */
    @NotNull(message = "当前工作范围的权限不能为空", groups = {ADD.class, EDIT.class})
    private String authority;

    /**
     * 当前工作资料
     */
    @NotNull(message = "当前工作资料不能为空", groups = {ADD.class, EDIT.class})
    private String material;

    /**
     * 文件内容明细
     */
    @NotNull(message = "文件内容明细不能为空", groups = {ADD.class, EDIT.class})
    private String detail;

    /**
     * 文件存储路径
     */
    @NotNull(message = "文件存储路径不能为空", groups = {ADD.class, EDIT.class})
    private String storage;

    /**
     * 任务交接类型
     */
    @NotNull(message = "任务交接类型不能为空", groups = {ADD.class, EDIT.class})
    private String handoverType;

    /**
     * 任务交接内容明细
     */
    @NotNull(message = "任务交接内容明细不能为空", groups = {ADD.class, EDIT.class})
