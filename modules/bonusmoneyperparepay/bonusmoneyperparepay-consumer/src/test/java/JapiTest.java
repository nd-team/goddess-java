...
//		JapiClient.delete(true);
		...
		JapiClient.setProjectJavaPath("modules/bonusmoneyperparepay/bonusmoneyperparepay-consumer");//主项目位置
		JapiClient.setActionReletivePath("com/bjike/goddess/bonusmoneyperparepay/action/");//主项目action位置
		JapiClient.setIncludeProjectJavaPath(new String[]{//关联项目
				"modules/bonusmoneyperparepay/bonusmoneyperparepay-api",
