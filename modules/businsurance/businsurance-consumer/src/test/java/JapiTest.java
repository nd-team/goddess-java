...
//		JapiClient.delete(true);
		...
		JapiClient.setProjectJavaPath("modules/businsurance/businsurance-consumer");//主项目位置
		JapiClient.setActionReletivePath("com/bjike/goddess/businsurance/action");//主项目action位置
		JapiClient.setIncludeProjectJavaPath(new String[]{//关联项目
				"modules/businsurance/businsurance-api",
