 ...
 * @Copy: [com.bjike]
 */
public class PayedCollectBO extends BaseBO{
    /**
     * 地区
     */
    private String area;
    ...
    public PayedCollectBO(String area,String project,Double supplementFee,Double carRentalUtilCost,Double overWorkTime,Double overWorkCost,Double parkCost,Double roadCost,Double mealCost,Double total){
        this.area = area;
        this.project = project;
        this.supplementFee = supplementFee;
        this.carRentalUtilCost = carRentalUtilCost;
