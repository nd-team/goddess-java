 ...
 */
@Entity
@Table(name = "staffpay_firstpayrecord")
public class FirstPayRecord extends BaseEntity {
     ...
     * 出勤天数
     */
    @Column(name = "attendanceDay", columnDefinition = "DECIMAL(10,2)   COMMENT '出勤天数'")
     ...
     * 电脑补助
     */
    @Column(name = "computerHelp", columnDefinition = "DECIMAL(10,2)   COMMENT '电脑补助'")
    private Double computerHelp;

    /**
     * 住宿补助
     */
    @Column(name = "stayHelp", columnDefinition = "DECIMAL(10,2)   COMMENT '住宿补助'")
    private Double stayHelp;

    /**
     * 工龄补助
     */
    @Column(name = "lengthHelp", columnDefinition = "DECIMAL(10,2)   COMMENT '工龄补助'")
    private Double lengthHelp;

    /**
     * 高温补助
     */
    @Column(name = "hyperthermiaHelp", columnDefinition = "DECIMAL(10,2)   COMMENT '高温补助'")
    private Double hyperthermiaHelp;

    /**
     * 社保补助
     */
    @Column(name = "socialHelp",  columnDefinition = "DECIMAL(10,2)   COMMENT '社保补助'")
     ...
     * 工资总额
     */
    @Column(name = "totalWages",  columnDefinition = "DECIMAL(10,2)   COMMENT '工资总额'")
    private Double totalWages;

    /**
     * 假期加班费
     */
    @Column(name = "holidayOvertimePay", columnDefinition = "DECIMAL(10,2)   COMMENT '假期加班费'")
    private Double holidayOvertimePay;

    /**
     * 社保扣款
     */
    @Column(name = "socialDeduction",  columnDefinition = "DECIMAL(10,2)   COMMENT '社保扣款'")
    private Double socialDeduction;

    /**
     * 水电费扣款
     */
    @Column(name = "utilitiesDeduction",  columnDefinition = "DECIMAL(10,2)   COMMENT '水电费扣款'")
    private Double utilitiesDeduction;

    /**
     * 扣分合计
     */
    @Column(name = "deductionTotal",  columnDefinition = "DECIMAL(10,2)   COMMENT '扣分合计'")
    private Double deductionTotal;

    /**
     * 奖金处罚扣款
     */
    @Column(name = "bonusPenaltyDeduction", columnDefinition = "DECIMAL(10,2)   COMMENT '奖金处罚扣款'")
    private Double bonusPenaltyDeduction;

    /**
     * 个税扣款
     */
    @Column(name = "incomeTaxDeduction", columnDefinition = "DECIMAL(10,2)   COMMENT '个税扣款'")
    private Double incomeTaxDeduction;

    /**
     * 事病假扣款
     */
    @Column(name = "whatSickLeaveDeduction", columnDefinition = "DECIMAL(10,2)   COMMENT '事病假扣款'")
    private Double whatSickLeaveDeduction;

    /**
     * 旷工扣款
     */
    @Column(name = "absenteeismDeduction",  columnDefinition = "DECIMAL(10,2)   COMMENT '旷工扣款'")
    private Double absenteeismDeduction;

    /**
     * 实发工资
     */
    @Column(name = "realWages",  columnDefinition = "DECIMAL(10,2)   COMMENT '实发工资'")
