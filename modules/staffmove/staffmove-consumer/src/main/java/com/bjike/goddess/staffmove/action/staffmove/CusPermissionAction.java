...
import com.bjike.goddess.staffmove.api.CusPermissionAPI;
import com.bjike.goddess.staffmove.bo.CusOperateBO;
import com.bjike.goddess.staffmove.bo.CusPermissionBO;
import com.bjike.goddess.staffmove.dto.CusPermissionDTO;
import com.bjike.goddess.staffmove.to.CusPermissionTO;
import com.bjike.goddess.staffmove.vo.CusOperateVO;
import com.bjike.goddess.staffmove.vo.CusPermissionVO;
...
public class CusPermissionAction {
     ...
     * 列表总条数
     *
     * @param cusPermissionDTO 权限信息dto
     * @des 获取所有权限信息总条数
     * @version v1
     */
    @GetMapping("v1/count")
     ...
     * 编辑权限
     *
     * @param cusPermissionTO 权限基本信息数据bo
     * @return class CusPermissionVO
     * @des 编辑权限
     * @version v1
     */
