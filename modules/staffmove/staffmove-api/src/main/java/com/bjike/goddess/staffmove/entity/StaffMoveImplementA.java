 ...
 */
@Entity
@Table(name = "staffmove_staffmoveimplementa")
public class StaffMoveImplementA extends BaseEntity {
     ...
     * 计划解决需求时间
     */
    @Column(name = "planSolveDemandTime", columnDefinition = "DATE   COMMENT '计划解决需求时间'")
    private LocalDate planSolveDemandTime;

    /**
     * 可调动人数
     */
    @Column(name = "mayTransferNum", columnDefinition = "INT(10)   COMMENT '可调动人数'")
    ...
    public LocalDate getPlanSolveDemandTime() {
        return planSolveDemandTime;
    }

    public void setPlanSolveDemandTime(LocalDate planSolveDemandTime) {
