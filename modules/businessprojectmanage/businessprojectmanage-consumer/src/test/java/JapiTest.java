...
//		JapiClient.delete(true);
        ...
        JapiClient.setProjectJavaPath("modules/businessprojectmanage/businessprojectmanage-consumer");//主项目位置
        JapiClient.setActionReletivePath("com/bjike/goddess/businessprojectmanage/action");//主项目action位置
        JapiClient.setIncludeProjectJavaPath(new String[]{//关联项目
                "modules/businessprojectmanage/businessprojectmanage-api",
