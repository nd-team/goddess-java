...
public class AssetDebtData extends BaseEntity {
     ...
     * 资产期末数
     */
    @Column(name = "负债和所有者权益期末数",  columnDefinition = "DECIMAL(10,2)   COMMENT '负债和所有者权益期末数'")
    ...
    public AssetDebtData(LocalDate startTime, LocalDate endTime, String project, Integer num, BigDecimal beginAsset, BigDecimal endAsset) {
