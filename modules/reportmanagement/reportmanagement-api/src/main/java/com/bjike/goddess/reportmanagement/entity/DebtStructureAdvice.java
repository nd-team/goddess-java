 ...
 */
@Entity
@Table(name = "reportmanagement_debtstructureadvice")
public class DebtStructureAdvice extends BaseEntity {

    /**
     * 流动负债比例最小值
     */
    @Column(name = "flowMin", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '流动负债比例最小值'")
    private Double flowMin;

    /**
     * 流动负债比例最大值
     */
    @Column(name = "flowMax", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '流动负债比例最大值'")
    private Double flowMax;

    /**
     * 长期负债比例最小值
     */
    @Column(name = "longMin", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '长期负债比例最小值'")
    private Double longMin;

    /**
     * 长期负债比例最大值
     */
    @Column(name = "longMax", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '长期负债比例最大值'")
    private Double longMax;

    /**
     * 所有者权益比例最小值
     */
    @Column(name = "allMin", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '所有者权益比例最小值'")
    private Double allMin;

    /**
     * 所有者权益比例最大值
     */
    @Column(name = "allMax", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '所有者权益比例最大值'")
