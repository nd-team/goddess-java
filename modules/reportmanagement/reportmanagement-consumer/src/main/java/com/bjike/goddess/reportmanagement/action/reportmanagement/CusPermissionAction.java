...
import com.bjike.goddess.reportmanagement.api.CusPermissionAPI;
import com.bjike.goddess.reportmanagement.bo.CusOperateBO;
import com.bjike.goddess.reportmanagement.bo.CusPermissionBO;
import com.bjike.goddess.reportmanagement.dto.CusPermissionDTO;
import com.bjike.goddess.reportmanagement.to.CusPermissionTO;
import com.bjike.goddess.reportmanagement.vo.CusOperateVO;
import com.bjike.goddess.reportmanagement.vo.CusPermissionVO;
...
public class CusPermissionAction {
     ...
     * 一个科目汇总表权限
     *
     * @param id 科目汇总表权限信息id
     * @return class CusPermissionVO
     * @des 根据id获取所有科目汇总表权限信息
     * @version v1
     */
     ...
     * 编辑科目汇总表权限
     *
     * @param cusPermissionTO 科目汇总表权限基本信息数据bo
     * @return class CusPermissionVO
     * @des 编辑科目汇总表权限
     * @version v1
     */
