 ...
 * @Copy: [ com.bjike ]
 */
public class BuyCusPermissionVO {
     ...
     * list返回的操作对象
     */
    private List<BuyCusOperateVO> cusOperateVO;
    ...
    public List<BuyCusOperateVO> getCusOperateVO() {
        return cusOperateVO;
    }

    public void setCusOperateVO(List<BuyCusOperateVO> cusOperateVO) {
