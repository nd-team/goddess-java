 ...
 * @Copy: [ com.bjike ]
 */
public class BuyCusPermissionBO extends BaseBO {
     ...
     * list返回的操作对象
     */
    private List<BuyCusOperateBO> cusOperateBO;
    ...
    public List<BuyCusOperateBO> getCusOperateBO() {
        return cusOperateBO;
    }

    public void setCusOperateBO(List<BuyCusOperateBO> cusOperateBO) {
