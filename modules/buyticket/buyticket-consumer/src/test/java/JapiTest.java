...
public class JapiTest {
	...
	public static void main(String[] args) throws IOException {
		...
		JapiClient.setProjectJavaPath("modules/buyticket/buyticket-consumer");//主项目位置
		JapiClient.setActionReletivePath("com/bjike/goddess/buyticket/action");//主项目action位置
		JapiClient.setIncludeProjectJavaPath(new String[]{//关联项目
				"modules/buyticket/buyticket-api",
				"common/common-api",
