...
import com.bjike.goddess.buyticket.bo.CusOperateBO;
import com.bjike.goddess.buyticket.bo.CusPermissionBO;
import com.bjike.goddess.buyticket.dto.CusPermissionDTO;
import com.bjike.goddess.buyticket.to.CusPermissionTO;
import com.bjike.goddess.buyticket.vo.CusOperateVO;
import com.bjike.goddess.buyticket.vo.CusPermissionVO;
...
public class CusPermissionAct {
    ...
    public Result getOneById(@PathVariable String id) throws ActException {
        try {
            CusPermissionBO temp = buycusPermissionAPI.getOneById(id);
    ...
    public Result findListCusPermission(CusPermissionDTO dto, BindingResult bindingResult, HttpServletRequest request) throws ActException {
        try {
            List<CusPermissionBO> boList = buycusPermissionAPI.list(dto);
    ...
    public Result editCusPermission(@Validated CusPermissionTO to) throws ActException {
        try {
            CusPermissionBO cusPermissionBO1 = buycusPermissionAPI.edit(to);
