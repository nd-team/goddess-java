...
/**
* 结算工作进度管理持久化接口, 继承基类可使用ｊｐａ命名查询
* @Author:			[ lijuntao ]
* @Date:			[  2017-11-18 03:09 ]
* @Description:	[ 结算工作进度管理持久化接口, 继承基类可使用ｊｐａ命名查询 ]
* @Version:		[ v1.0.0 ]
* @Copy:   		[ com.bjike ]
*/
public interface SettleWorkProgreManageRep extends JpaRep<SettleWorkProgreManage ,SettleWorkProgreManageDTO> { 
