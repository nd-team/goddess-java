...
* 协助人
*/
@Column(name = "assistPeoper",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '协助人'"  ) 
...
* 协助完成时间
*/
@Column(name = "assistDate",nullable = false,columnDefinition = "DATE   COMMENT '协助完成时间'"  ) 
 private LocalDate  assistDate; 

/**
* 资金模块
*/
@Column(name = "moneyModule",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '资金模块'"  ) 
 private String  moneyModule; 

/**
* 资金模块意见
*/
@Column(name = "moneyModuleOpinion",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '资金模块意见'"  ) 
...
* 审批情况
*/
@Column(name = "approvalExam",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '审批情况'"  ) 
