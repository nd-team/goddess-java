 ...
 * @Description: [ 结算进度管理业务传输对象 ]
 * @Version: [ v1.0.0 ]
 * @Copy: [ com.bjike ]
 */
public class ScreeningSettleProgressManageBO extends BaseBO {
     ...
     * 表头数据
     */
    private List<HeadersCustomBO> headersCustomBOList;
    /**
     * 节点表头数据
     */
    private List<NodeHeadersCustomBO> nodeHeadersCustomBOList;
    ...
    public List<HeadersCustomBO> getHeadersCustomBOList() {
        return headersCustomBOList;
    }

    public void setHeadersCustomBOList(List<HeadersCustomBO> headersCustomBOList) {
        this.headersCustomBOList = headersCustomBOList;
    }

    public List<NodeHeadersCustomBO> getNodeHeadersCustomBOList() {
        return nodeHeadersCustomBOList;
    }

    public void setNodeHeadersCustomBOList(List<NodeHeadersCustomBO> nodeHeadersCustomBOList) {
        this.nodeHeadersCustomBOList = nodeHeadersCustomBOList;
    }
}