 ...
 * @Copy: [ com.bjike ]
 */
public class ProjectSettlementFollowTO extends BaseTO {
     ...
     * 地区
     */
    @NotBlank(groups = ProjectSettlementFollowTO.TESTAddAndEdit.class,message = "地区不能为空")
    private String area;

    /**
     * 业务类型
     */
    @NotBlank(groups = ProjectSettlementFollowTO.TESTAddAndEdit.class,message = "业务类型不能为空")
    private String businessType;

    /**
     * 业务方向科目
     */
    @NotBlank(groups = ProjectSettlementFollowTO.TESTAddAndEdit.class,message = "业务方向科目不能为空")
    private String businessSubject;

    /**
     * 运营商名称
     */
    @NotBlank(groups = ProjectSettlementFollowTO.TESTAddAndEdit.class,message = "运营商名称不能为空")
     ...
     * 外包单位
     */
    @NotBlank(groups = ProjectSettlementFollowTO.TESTAddAndEdit.class,message = "外包单位不能为空")
    private String outsourcingUnit;

    /**
     * 合同外部项目名称
     */
    @NotBlank(groups = ProjectSettlementFollowTO.TESTAddAndEdit.class,message = "合同外部项目名称不能为空")
    private String outerName;

    /**
     * 内部项目名称
     */
    @NotBlank(groups = ProjectSettlementFollowTO.TESTAddAndEdit.class,message = "内部项目名称不能为空")
     ...
     * 派工单编号
     */
    @NotBlank(groups = ProjectSettlementFollowTO.TESTAddAndEdit.class,message = "派工单编号不能为空")
    private String dispatchNum;

    /**
     * 销售合同号
     */
    @NotBlank(groups = ProjectSettlementFollowTO.TESTAddAndEdit.class,message = "销售合同号不能为空")
    private String saleNum;

    /**
     * 合同金额
     */
    @NotNull(groups = ProjectSettlementFollowTO.TESTAddAndEdit.class,message = "合同金额不能为空,且是数字")
    private Double contractMoney;

    /**
     * 合同规模数
     */
    @NotNull(groups = ProjectSettlementFollowTO.TESTAddAndEdit.class,message = "合同规模数不能为空,且是数字")
     ...
     * 派工金额
     */
    @NotNull(groups = ProjectSettlementFollowTO.TESTAddAndEdit.class,message = "派工金额不能为空,且是数字")
    private Double dispatchMoney;

    /**
     * 单价
     */
    @NotNull(groups = ProjectSettlementFollowTO.TESTAddAndEdit.class,message = "单价不能为空,且是数字")
     ...
     * 是否初验
     */
    @NotBlank(groups = ProjectSettlementFollowTO.TESTAddAndEdit.class,message = "是否初验不能为空")
    private String startCheckCondition;

    /**
     * 是否终验
     */
    @NotBlank(groups = ProjectSettlementFollowTO.TESTAddAndEdit.class,message = "是否终验不能为空")
    private String finalCheckCondition;

    /**
     * 是否已制作申请结算资料
     */
    @NotBlank(groups = ProjectSettlementFollowTO.TESTAddAndEdit.class,message = "是否已制作申请结算资料不能为空")
    private String settleFileCondition;

    /**
     * 是否影响结算
     */
    @NotBlank(groups = ProjectSettlementFollowTO.TESTAddAndEdit.class,message = "是否影响结算不能为空")
     ...
     * 管理费
     */
    @NotNull(groups = ProjectSettlementFollowTO.TESTAddAndEdit.class,message = "管理费不能为空,且是数字")
    private Double manageFee;

    /**
     * 违约金
     */
    @NotNull(groups = ProjectSettlementFollowTO.TESTAddAndEdit.class,message = "违约金不能为空,且是数字")
     ...
     * 结算进度A
     */
    @NotBlank(groups = ProjectSettlementFollowTO.TESTAddAndEdit.class,message = "结算进度A不能为空")
    private String settleProcingA;

    /**
     * 结算进度B
     */
    @NotBlank(groups = ProjectSettlementFollowTO.TESTAddAndEdit.class,message = "结算进度B不能为空")
    private String settleProcingB;

    /**
     * 结算进度C
     */
    @NotBlank(groups = ProjectSettlementFollowTO.TESTAddAndEdit.class,message = "结算进度C不能为空")
    private String settleProcingC;

    /**
     * 结算金额
     */
    @NotNull(groups = ProjectSettlementFollowTO.TESTAddAndEdit.class,message = "结算金额不能为空,且是数字")
    private Double settleMoney;

    /**
     * 剩余结算数量
     */
    @NotNull(groups = ProjectSettlementFollowTO.TESTAddAndEdit.class,message = "剩余结算数量不能为空,且是数字")
    private Double restSettleNum;

    /**
     * 剩余结算金额
     */
    @NotNull(groups = ProjectSettlementFollowTO.TESTAddAndEdit.class,message = "剩余结算金额不能为空,且是数字")
     ...
     * 到帐金额
     */
    @NotNull(groups = ProjectSettlementFollowTO.TESTAddAndEdit.class,message = "到帐金额不能为空,且是数字")
