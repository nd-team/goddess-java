 ...
 * @Copy: [ com.bjike ]
 */
public class SettleProgressManageTO extends BaseTO {
     ...
     * 派工名称
     */
    @NotBlank(message = "派工名称不能为空", groups = {ADD.class, EDIT.class})
    private String dispatName;

    /**
     * 厂家
     */
    @NotBlank(message = "厂家不能为空", groups = {ADD.class, EDIT.class})
    private String manufacturer;

    /**
     * 销售合同号
     */
    @NotBlank(message = "销售合同号不能为空", groups = {ADD.class, EDIT.class})
     ...
     * 派工情况
     */
    @NotNull(message = "派工情况不能为空", groups = {ADD.class, EDIT.class})
     ...
     * 实际完工状态
     */
    @NotNull(message = "实际完工状态不能为空", groups = {ADD.class, EDIT.class})
     ...
     * KPI
     */
    @NotNull(message = "KPI不能为空", groups = {ADD.class, EDIT.class})
    private Kpi kpi;
     ...
     * 自定义字段
     */
    private List<HeadersCustomTO> headersCustomTOS;

    /**
     * 自定义节点
     */
    private List<NodeHeadersCustomTO> nodeHeadersCustomTOS;
    ...
    public List<HeadersCustomTO> getHeadersCustomTOS() {
        return headersCustomTOS;
    }

    public void setHeadersCustomTOS(List<HeadersCustomTO> headersCustomTOS) {
        this.headersCustomTOS = headersCustomTOS;
    }

    public List<NodeHeadersCustomTO> getNodeHeadersCustomTOS() {
        return nodeHeadersCustomTOS;
    }

    public void setNodeHeadersCustomTOS(List<NodeHeadersCustomTO> nodeHeadersCustomTOS) {
        this.nodeHeadersCustomTOS = nodeHeadersCustomTOS;
    }
}