 ...
 * @Copy: [ com.bjike ]
 */
public class ProjectSituationTO extends BaseTO {
     ...
     * 派工单编号
     */
    @NotBlank(groups = ProjectSituationTO.TESTAddAndEdit.class,message = "派工单编号不能为空")
     ...
     * 工程地点
     */
    @NotBlank(groups = ProjectSituationTO.TESTAddAndEdit.class,message = "工程地点不能为空")
     ...
     * 完工情况
     */
    @NotBlank(groups = ProjectSituationTO.TESTAddAndEdit.class,message = "完工情况不能为空")
