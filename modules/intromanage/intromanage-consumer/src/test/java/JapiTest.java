...
//		JapiClient.delete(true);
		...
		JapiClient.setProjectJavaPath("modules/intromanage/intromanage-consumer");//主项目位置
		JapiClient.setActionReletivePath("com/bjike/goddess/intromanage/action");//主项目action位置
