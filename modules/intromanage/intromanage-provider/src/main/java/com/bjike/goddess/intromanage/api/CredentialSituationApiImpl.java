...
public class CredentialSituationApiImpl implements CredentialSituationAPI {
     ...
     */
    @Override
    public CredentialSituationBO findById(String id) throws SerException {
        CredentialSituation model = credentialSituationSer.findById(id);
        return BeanTransform.copyProperties(model, CredentialSituationBO.class);
    }
     ...
     */
    @Override
    public Long count(CredentialSituationDTO dto) throws SerException {
        return credentialSituationSer.count(dto);
    }
