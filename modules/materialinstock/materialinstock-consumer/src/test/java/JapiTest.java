...
//		JapiClient.delete(true);
		...
		JapiClient.setProjectJavaPath("modules/materialinstock/materialinstock-consumer");//主项目位置
		JapiClient.setActionReletivePath("com/bjike/goddess/materialinstock/action");//主项目action位置
