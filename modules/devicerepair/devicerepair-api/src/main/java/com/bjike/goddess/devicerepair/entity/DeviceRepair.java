...
public class DeviceRepair extends BaseEntity {
     ...
     * 地区
     */
    @Column(name = "area", nullable = false, columnDefinition = "VARCHAR(255) COMMIT '地区'")
    private String area;

    /**
     * 项目组
     */
    @Column(name = "projectGroup", nullable = false, columnDefinition = "VARCHAR(255) COMMIT '项目组'")
    private String projectGroup;

    /**
     * 项目名称
     */
    @Column(name = "projectName", nullable = false, columnDefinition = "VARCHAR(255) COMMIT '项目名称'")
    private String projectName;

    /**
     * 申请人
     */
    @Column(name = "applicant", nullable = false, columnDefinition = "VARCHAR(255) COMMIT '申请人'")
    private String applicant;

    /**
     * 设备名称
     */
    @Column(name = "deviceName", nullable = false, columnDefinition = "VARCHAR(255) COMMIT '设备名称'")
    private String deviceName;

    /**
     * 物资编号
     */
    @Column(name = "materialCoding", nullable = false, columnDefinition = "VARCHAR(255) COMMIT '物资编号'")
    private String materialCoding;

    /**
     * 经手人
     */
    @Column(name = "handler", nullable = false, columnDefinition = "VARCHAR(255) COMMIT '经手人'")
    private String handler;

    /**
     * 设备负责人
     */
    @Column(name = "devicePrincipal", nullable = false, columnDefinition = "VARCHAR(255) COMMIT '设备负责人'")
    private String devicePrincipal;

    /**
     * 设备出现的问题
     */
    @Column(name = "deviceIssue", nullable = false, columnDefinition = "VARCHAR(255) COMMIT '设备出现的问题'")
    private String deviceIssue;

    /**
     * 备注
     */
    @Column(name = "comment", columnDefinition = "VARCHAR(255) COMMIT '备注'")
    private String comment;

    /**
     * 物资状态
     */
    @Column(name = "materialState", nullable = false, columnDefinition = "TINYINT(2) COMMIT '物资状态'")
    private MaterialState materialState;

    /**
     * 保修期限(月)
     */
    @Column(name = "termOfService", nullable = false, columnDefinition = "DECIMAL(10,2) COMMIT '保修期限(月)'")
     ...
     * 保修联系人
     */
    @Column(name = "warrantyContact", columnDefinition = "VARCHAR(255) COMMIT '保修联系人'")
    private String warrantyContact;

    /**
     * 保修联系电话
     */
    @Column(name = "warrantyContactPhone", columnDefinition = "VARCHAR(255) COMMIT '保修联系电话'")
    private String warrantyContactPhone;

    /**
     * 购买网址/店铺
     */
    @Column(name = "buyAddress", columnDefinition = "VARCHAR(255) COMMIT '购买网址/店铺'")
    private String buyAddress;

    /**
     * 购买途径
     */
    @Column(name = "purchaseWay", columnDefinition = "VARCHAR(255) COMMIT '购买途径'")
    private String purchaseWay;

    /**
     * 维修途径
     */
    @Column(name = "repairWay", columnDefinition = "VARCHAR(255) COMMIT '维修途径'")
    private String repairWay;

    /**
     * 检测结果
     */
    @Column(name = "detectResult", columnDefinition = "VARCHAR(255) COMMIT '检测结果'")
     ...
     * 维修后使用期限
     */
    @Column(name = "repairDeadline", columnDefinition = "VARCHAR(255) COMMIT '维修后使用期限'")
    private String repairDeadline;

    /**
     * 维修价格
     */
    @Column(name = "repairPrice", columnDefinition = "DECIMAL(10,2) COMMIT '维修价格'")
    private Double repairPrice;

    /**
     * 预计维修好时间
     */
    @Column(name = "planOverRepairTime", columnDefinition = "DATETIME COMMIT '预计维修好时间'")
    private LocalDateTime planOverRepairTime;

    /**
     * 预计借款时间
     */
    @Column(name = "planLoanTime", columnDefinition = "DATETIME COMMIT '预计借款时间'")
    private LocalDateTime planLoanTime;

    /**
     * 福利模块负责人
     */
    @Column(name = "welfareModule", nullable = false, columnDefinition = "VARCHAR(255) COMMIT '福利模块负责人'")
    private String welfareModule;

    /**
     * 福利模块负责人审核状态
     */
    @Column(name = "welfareAuditState", nullable = false, columnDefinition = "TINYINT(2) DEFAULT 0 COMMIT '福利模块负责人审核状态'")
    private AuditState welfareAuditState;

    /**
     * 项目经理
     */
    @Column(name = "pm", nullable = false, columnDefinition = "VARCHAR(255) COMMIT '项目经理'")
    private String pm;

    /**
     * 项目经理审核状态
     */
    @Column(name = "pmAuditState", nullable = false, columnDefinition = "TINYINT(2) DEFAULT 0 COMMIT '项目经理审核状态'")
    private AuditState pmAuditState;

    /**
     * 厂家收款方式
     */
    @Column(name = "venderReceiptMode", columnDefinition = "VARCHAR(255) COMMIT '厂家收款方式'")
    private String venderReceiptMode;

    /**
     * 开户名称
     */
    @Column(name = "accountName", columnDefinition = "VARCHAR(255) COMMIT '开户名称'")
    private String accountName;

    /**
     * 开户账号
     */
    @Column(name = "accountNumber", columnDefinition = "VARCHAR(255) COMMIT '开户账号'")
    private String accountNumber;

    /**
     * 开户行
     */
    @Column(name = "bankOfDeposit", columnDefinition = "VARCHAR(255) COMMIT '开户行'")
