 ...
 * @Copy: [ com.bjike ]
 */
public interface TaskReceiveSer extends Ser<TaskReceive, TaskReceiveDTO> {
     ...
     * @return 任务接收
     */
    TaskReceiveBO insertModel(TaskReceiveTO to) throws SerException;
     ...
     * @return 任务接收
     */
    TaskReceiveBO updateModel(TaskReceiveTO to) throws SerException;
