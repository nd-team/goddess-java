...
public class PeopleNoStatTO extends BaseTO {
     ...
     * 获奖名次
     */
    @NotNull(groups = {PeopleNoStatTO.IAwardDetail.class}, message = "获奖名次不能为空")
    private String[] awardRankings;

    /**
     * 获奖人姓名
     */
    @NotNull(groups = {PeopleNoStatTO.IAwardDetail.class}, message = "获奖人姓名不能为空")
    private String[] prizewinners;

    /**
     * 奖金额度
     */
    @NotNull(groups = {PeopleNoStatTO.IAwardDetail.class}, message = "奖金额度不能为空")
    private Double[] bonusLimits;

    /**
     * 经验值额度
     */
    @NotNull(groups = {PeopleNoStatTO.IAwardDetail.class}, message = "经验值额度不能为空")
