...
public class DetailTO extends BaseTO {
     ...
     * 奖品明细
     */
    @NotNull(groups = {DetailTO.IPrizeDetail.class}, message = "奖品明细不能为空")
    private String prizeDetails;

    /**
     * 奖品购置途径
     */
    @NotNull(groups = {DetailTO.IPrizeDetail.class}, message = "奖品购置途径不能为空")
    private String prizeBuyWays;

    /**
     * 奖品发放形式
     */
    @NotNull(groups = {DetailTO.IPrizeDetail.class}, message = "奖品发放形式不能为空")
    private String prizeIssueForms;

    /**
     * 颁奖时间
     */
    @NotNull(groups = {DetailTO.IPrizeDetail.class}, message = "颁奖时间不能为空")
