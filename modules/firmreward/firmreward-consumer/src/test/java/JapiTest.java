...
public class JapiTest {
	...
	public static void main(String[] args) throws IOException {
		...
		JapiClient.setProjectJavaPath("modules/firmreward/firmreward-consumer");//主项目位置
		JapiClient.setActionReletivePath("com/bjike/goddess/firmreward/action");//主项目action位置
		JapiClient.setIncludeProjectJavaPath(new String[]{//关联项目
				"modules/firmreward/firmreward-api",
				"common/common-api"
		});
