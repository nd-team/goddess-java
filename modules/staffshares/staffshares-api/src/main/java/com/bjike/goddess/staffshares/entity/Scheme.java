...
public class Scheme extends BaseEntity {
     ...
     * 方案制定时间
     */
    @Column(name = "programmeTime", nullable = true, columnDefinition = "DATETIME   COMMENT '方案制定时间'")
    private LocalDateTime programmeTime;

    /**
     * 方案制定人
     */
    @Column(name = "setters", nullable = true, columnDefinition = "VARCHAR(255)   COMMENT '方案制定人'")
     ...
     * 审核意见
     */
    @Column(name = "opinion", nullable = true, columnDefinition = "VARCHAR(255)   COMMENT '审核意见'")
