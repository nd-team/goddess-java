...
public class ReceivedFeedback extends BaseEntity {
     ...
     * 优先级（系统计算分值）
     */
    @Column(nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '优先级（系统计算分值）'")
    private Integer systemPriority;

    /**
     * 优先级（人工编辑）
     */
    @Column( nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '优先级（人工编辑）'")
    private Integer artificialPriority;

    /**
     * 非责任相关人意见数(提供接口查询详情)
     */
    @Column( nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '非责任相关人意见数(提供接口查询详情)'")
    private Integer responsibleNum;

    /**
     * 一线项目组意见-建议描述
     */
    @Column(name = "firstProjectGroupOpinion", nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '一线项目组意见-建议描述'")
    private String firstProjectGroupOpinion;

    /**
     * 意见提出人
     */
    @Column(name = "firstIdea", nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '意见提出人'")
    private String firstIdea;

    /**
     * 规划模块意见-建议描述
     */
    @Column(name = "planOpinion", nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '规划模块意见-建议描述'")
    private String planOpinion;

    /**
     * 意见提出人
     */
    @Column(name = "planIdea", nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '意见提出人'")
    private String planIdea;

    /**
     * 综合素养意见-建议描述
     */
    @Column(name = "literacyOpinion", nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '综合素养意见-建议描述'")
    private String literacyOpinion;

    /**
     * 意见提出人
     */
    @Column(name = "literacyIdea", nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '意见提出人'")
    private String literacyIdea;

    /**
     * 商务市场部意见-建议描述
     */
    @Column(name = "businessOpinion", nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '商务市场部意见-建议描述'")
    private String businessOpinion;

    /**
     * 意见提出人
     */
    @Column(name = "businessIdea", nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '意见提出人'")
    private String businessIdea;

    /**
     * 资金意见-建议描述
     */
    @Column(name = "moneyOpinion", nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '资金意见-建议描述'")
    private String moneyOpinion;

    /**
     * 意见提出人
     */
    @Column(name = "moneyIdea", nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '意见提出人'")
    private String moneyIdea;

    /**
     * 账务意见-建议描述
     */
    @Column(name = "accountOpinion", nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '账务意见-建议描述'")
    private String accountOpinion;

    /**
     * 意见提出人
     */
    @Column(name = "accountIdea", nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '意见提出人'")
    private String accountIdea;

    /**
     * 预算意见-建议描述
     */
    @Column(name = "budgetOpinion", nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '预算意见-建议描述'")
    private String budgetOpinion;

    /**
     * 意见提出人
     */
    @Column(name = "budgetIdea", nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '意见提出人'")
    private String budgetIdea;

    /**
     * 研发部意见-建议描述
     */
    @Column(name = "divisionOpinion", nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '研发部意见-建议描述'")
    private String divisionOpinion;

    /**
     * 意见提出人
     */
    @Column(name = "divisionIdea", nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '意见提出人'")
    private String divisionIdea;

    /**
     * 总经办（公司宏观视角）意见-建议描述
     */
    @Column(name = "generalManagerOpinion", nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '总经办（公司宏观视角）意见-建议描述'")
    private String generalManagerOpinion;

    /**
     * 总经办（公司宏观视角）意见提出人
     */
    @Column(name = "generalManagerIdea", nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '总经办（公司宏观视角）意见提出人'")
