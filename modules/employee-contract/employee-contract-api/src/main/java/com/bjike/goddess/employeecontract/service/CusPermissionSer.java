...
public interface CusPermissionSer extends Ser<CusPermission, CusPermissionDTO> {
    ...
    /**
     * 根据idFlag查询可以某种操作的客户权限岗位
     *
     * @param idFlag 客户权限idFlag
     * @throws SerException
     */
    default Boolean positCusPermission(String idFlag) throws SerException {
        return null;
    }
    /**
     ...
     * @throws SerException
     */
    default Boolean leveCusPermission(String idFlag) throws SerException {
        return null;
    }
