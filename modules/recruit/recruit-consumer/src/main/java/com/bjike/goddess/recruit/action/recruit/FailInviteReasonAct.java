...
public class FailInviteReasonAct {
    ...
    @LoginAuth
    @PostMapping("v1/add")
    public Result add(@Validated({ADD.class}) FailInviteReasonTO to, BindingResult result, HttpServletRequest request) throws ActException {
        try {
    ...
    @LoginAuth
    @PutMapping("v1/edit")
    public Result edit(@Validated({EDIT.class}) FailInviteReasonTO to, BindingResult result) throws ActException {
        try {
