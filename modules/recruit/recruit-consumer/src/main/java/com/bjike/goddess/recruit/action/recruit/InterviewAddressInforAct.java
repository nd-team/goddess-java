...
public class InterviewAddressInforAct {
     ...
     */
    @GetMapping("v1/list")
    public Result list(@Validated InterviewAddressInforDTO dto, BindingResult result, HttpServletRequest request) throws ActException {
        try {
    ...
    @LoginAuth
    @PostMapping("v1/add")
    public Result add(@Validated(value = {ADD.class}) InterviewAddressInforTO to, BindingResult result, HttpServletRequest request) throws ActException {
        try {
    ...
    @LoginAuth
    @PutMapping("v1/edit")
    public Result edit(@Validated(value = {EDIT.class}) InterviewAddressInforTO to, BindingResult result) throws ActException {
        try {
