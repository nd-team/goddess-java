...
public class RecruitPlanTO extends BaseTO {
     ...
     * 计划日面试量
     */
    @NotNull(groups = {ADD.class, EDIT.class}, message = "计划日面试量不能为空")
    private Integer planDayInterviewNo;

    /**
     * 计划日成功通过面试量
     */
    @NotNull(groups = {ADD.class, EDIT.class}, message = "计划日成功通过面试量不能为空")
    private Integer planDayPassInterviewNo;

    /**
     * 负责招聘员工
     */
    @NotBlank(groups = {ADD.class, EDIT.class}, message = "负责招聘员工不能为空")
