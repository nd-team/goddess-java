 ...
 * @Copy: [com.bjike]
 */
public class FirstPhoneRecordTemplateExcel {
    /**
     * 日期
     */
    @ExcelHeader(name = "日期")
    ...
    private LocalDate firstInterviewTime;
    ...
    public LocalDate getFirstInterviewTime() {
        return firstInterviewTime;
    }

    public void setFirstInterviewTime(LocalDate firstInterviewTime) {
        this.firstInterviewTime = firstInterviewTime;
    }

    public LocalDate getRetrialTime() {
        return retrialTime;
    }

    public void setRetrialTime(LocalDate retrialTime) {
