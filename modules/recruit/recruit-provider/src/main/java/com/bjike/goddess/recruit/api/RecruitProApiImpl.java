...
public class RecruitProApiImpl implements RecruitProAPI {
     ...
     *
     * @param id 招聘方案唯一标识
     * @param yyOpnion 运营商务部意见
     * @param pass 是否通过
     * @throws SerException
     */
    @Override
    public void yyEdit(String id, String yyOpnion, Boolean pass) throws SerException {
        recruitProSer.yyEdit(id, yyOpnion, pass);
    }
     ...
     */
    @Override
    public void managerEdit(String id, String zjbOpnion, Boolean pass) throws SerException {
        recruitProSer.managerEdit(id, zjbOpnion, pass);
    }
}
