 ...
 * @Copy: [ com.bjike ]
 */
public class VersionTO extends BaseTO {
    /**
     * 制度名
     */
    @NotBlank(groups = {ADD.class, EDIT.class},message = "制度名不能为空")
    private String name;
    /**
     * 功能目的
     */
     ...
     * 是否已开发
     */
    @NotNull(groups = {ADD.class, EDIT.class},message = "制度名不能为空")
     ...
     * 模块名
     */
    @NotBlank(groups = {ADD.class, EDIT.class},message = "模块名不能为空")
