...
import com.bjike.goddess.account.api.CusPermissionAPI;
import com.bjike.goddess.account.bo.CusOperateBO;
...
import com.bjike.goddess.account.vo.CusOperateVO;
import com.bjike.goddess.account.vo.CusPermissionVO;
...
public class CusPermissionAction {
     ...
     * 列表总条数
     *
     * @param cusPermissionDTO 明细账权限信息dto
     * @des 获取所有明细账权限信息总条数
     * @version v1
     */
    @GetMapping("v1/count")
     ...
     * 编辑明细账权限
     *
     * @param cusPermissionTO 明细账权限基本信息数据bo
     * @return class CusPermissionVO
     * @des 编辑明细账权限
     * @version v1
     */
