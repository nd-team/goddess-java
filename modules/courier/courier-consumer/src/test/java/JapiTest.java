...
public class JapiTest {
	...
	public static void main(String[] args) throws IOException {
		...
		JapiClient.setProjectJavaPath("modules/courier/courier-consumer");//主项目位置
		JapiClient.setActionReletivePath("com/bjike/goddess/courier/action");//主项目action位置
		JapiClient.setIncludeProjectJavaPath(new String[]{//关联项目
				"modules/courier/courier-api",
				"common/common-api",
