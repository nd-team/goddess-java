...
//		JapiClient.delete(true);
		...
		JapiClient.setProjectJavaPath("modules/checkfunds/checkfunds-consumer");//主项目位置
		JapiClient.setActionReletivePath("com/bjike/goddess/checkfunds/action/");//主项目action位置
		JapiClient.setIncludeProjectJavaPath(new String[]{//关联项目
				"modules/checkfunds/checkfunds-api",
