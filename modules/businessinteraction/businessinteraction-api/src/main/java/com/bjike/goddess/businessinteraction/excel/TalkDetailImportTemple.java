 ...
 * @Description: [ 资料信息导出模板 ]
 * @Version: [ v1.0.0 ]
 * @Copy: [ com.bjike ]
 */
public class TalkDetailImportTemple extends BaseBO {
    ...
    public String getReachedCooper() {
        return reachedCooper;
    }

    public void setReachedCooper(String reachedCooper) {
