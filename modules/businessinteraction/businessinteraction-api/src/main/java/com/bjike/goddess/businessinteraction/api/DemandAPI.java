...
public interface DemandAPI {
     ...
     * @return class DemandBO
     */
    default List<DemandBO> listDemand(DemandDTO demandDTO) throws SerException {
        return null;
    }
     ...
     * @return class DemandBO
     */
    default DemandBO addDemand(DemandTO demandTO) throws SerException {
        return null;
    }
     ...
     * @return class DemandBO
     */
    default DemandBO editDemand(DemandTO demandTO) throws SerException {
        return null;
    }
     ...
     * @param id id
     */
    default void deleteDemand(String id) throws SerException {
        return;
    }
     ...
     * @return class DemandBO
     */
    default List<DemandBO> searchList(DemandDTO demandDTO) throws SerException {
        return null;
    }
     ...
     * @return class DemandBO
     */
    default List<DemandObjectBO> searchDemand(DemandDTO demandDTO) throws SerException {
        return null;
    }
