 ...
 * @Copy: [ com.bjike ]
 */
public class OverWorkExportExcel extends BaseBO {
     ...
     * 加班录入人
     */
    @ExcelHeader(name = "加班录入人")
    private String entryer;
    /**
     * 任务下达人
     */
    @ExcelHeader(name = "任务下达人")
    private String tasker;

    /**
     * 加班人员
     */
    @ExcelHeader(name = "加班人员")
    private String overWorker;

    /**
     * 加班类型
     */
    @ExcelHeader(name = "加班类型")
     ...
     * 加班时长
     */
    @ExcelHeader(name = "加班时长")
    private Double overLong;

    /**
     * 是否午休
     */
    @ExcelHeader(name = "是否午休")
     ...
     * 可休天数
     */
    @ExcelHeader(name = "可休天数")
    private Double relaxDay;

    /**
     * 负责人(审批人)
     */
    @ExcelHeader(name = "负责人(审批人)")
