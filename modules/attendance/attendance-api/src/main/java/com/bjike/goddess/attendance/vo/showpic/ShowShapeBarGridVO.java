 ...
 * @Copy: [ com.bjike ]
 */
public class ShowShapeBarGridVO implements Serializable {
    ...
    public ShowShapeBarGridVO() {
    }

    public ShowShapeBarGridVO(String left, String right, String bottom, Boolean containLabel) {
        this.left = left;
        this.right = right;
        this.bottom = bottom;
        this.containLabel = containLabel;
