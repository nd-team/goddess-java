 ...
 * @Copy: [ com.bjike ]
 */
public class VacatePhoneTO extends BaseTO {
     ...
     * 开始日期
     */
    @NotBlank(groups = {ADD.class,VacatePhoneTO.GETTIME.class},message = "开始日期不能为空")
    private String startDate;
    /**
     * 结束日期
     */
    @NotBlank(groups = {ADD.class,VacatePhoneTO.GETTIME.class},message = "结束日期不能为空")
    private String endDate;
    /**
     * 开始时间
     */
    @NotNull(groups = {ADD.class,VacatePhoneTO.GETTIME.class},message = "开始时间不能为空")
    private StartTime startTime;

    /**
     * 结束时间
     */
    @NotNull(groups = {ADD.class,VacatePhoneTO.GETTIME.class},message = "结束时间不能为空")
