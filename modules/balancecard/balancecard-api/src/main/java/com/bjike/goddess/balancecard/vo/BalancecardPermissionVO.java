 ...
 * @Description: [ 平衡计分卡权限配置表现层对象 ]
 * @Version: [ v1.0.0 ]
 * @Copy: [ com.bjike ]
 */
public class BalancecardPermissionVO {
     ...
     * list返回的操作对象
     */
    private List<BalancecardOperateVO> cusOperateVO;
    ...
    public List<BalancecardOperateVO> getCusOperateVO() {
        return cusOperateVO;
    }

    public void setCusOperateVO(List<BalancecardOperateVO> cusOperateVO) {
