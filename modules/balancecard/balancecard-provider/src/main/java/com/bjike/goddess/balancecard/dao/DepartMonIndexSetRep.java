...
/**
* 部门月度指标设置持久化接口, 继承基类可使用ｊｐａ命名查询
* @Author:			[ tanghaixiang ]
* @Date:			[  2017-05-19 09:33 ]
* @Description:	[ 部门月度指标设置持久化接口, 继承基类可使用ｊｐａ命名查询 ]
* @Version:		[ v1.0.0 ]
* @Copy:   		[ com.bjike ]
*/
public interface DepartMonIndexSetRep extends JpaRep<DepartMonIndexSet ,DepartMonIndexSetDTO> { 
