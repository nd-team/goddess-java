...
public class MarketServeRecordTemplateExprot extends BaseTO {
     ...
     * 实际活动时间点
     */
    @ExcelHeader(name = "实际活动时间点", notNull = true)
     ...
     * 实际参加人数
     */
    @ExcelHeader(name = "实际参加人数", notNull = true)
     ...
     * 实际活动类型
     */
    @ExcelHeader(name = "实际活动类型", notNull = true)
