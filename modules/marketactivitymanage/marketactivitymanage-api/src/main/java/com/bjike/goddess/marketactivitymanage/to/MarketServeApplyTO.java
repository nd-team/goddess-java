 ...
 *
 * @Author: [ sunfengtao ]
 * @Date: [ 2017-03-18T10:37:08.044 ]
 * @Description: [ ]
 * @Version: [ v1.0.0 ]
 * @Copy: [ com.bjike ]
 */
public class MarketServeApplyTO extends BaseTO {
     ...
     * 预计参加人数
     */
    @NotNull(groups = {ADD.class, EDIT.class}, message = "预计参加人数不能为空")
     ...
     * 运营商务部资金模块
     */
    @NotBlank(groups = {MarketServeApplyTO.FUNDMODULE.class}, message = "运营商务部资金模块不能为空")
    private String yyFundModule;

    /**
     * 资金模块意见
     */
    @NotBlank(groups = {MarketServeApplyTO.FUNDMODULE.class}, message = "资金模块意见不能为空")
    private String fundModuleOpinion;

    /**
     * 决策层
     */
    @NotBlank(groups = {MarketServeApplyTO.EXECUTIVE.class}, message = "决策层不能为空")
    private String decisionLevel;

    /**
     * 决策层审核意见
     */
    @NotNull(groups = {MarketServeApplyTO.EXECUTIVE.class}, message = "决策层审核意见不能为空")
