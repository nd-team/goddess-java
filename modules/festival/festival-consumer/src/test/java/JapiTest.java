...
public class JapiTest {
	...
	public static void main(String[] args) throws IOException {
		...
		JapiClient.setProjectJavaPath("modules/festival/festival-consumer");//主项目位置
		JapiClient.setActionReletivePath("com/bjike/goddess/festival/action");//主项目action位置
		JapiClient.setIncludeProjectJavaPath(new String[]{//关联项目
				"modules/festival/festival-api",
				"common/common-api"
		});
