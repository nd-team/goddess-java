...
//		JapiClient.delete(true);
		...
		JapiClient.setProjectJavaPath("modules/customerplatform/customerplatform-consumer");//主项目位置
		JapiClient.setActionReletivePath("com/bjike/goddess/customerplatform/action");//主项目action位置
		JapiClient.setIncludeProjectJavaPath(new String[]{//关联项目
				"modules/customerplatform/customerplatform-api",
