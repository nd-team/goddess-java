...
//        JapiClient.delete(true);
        ...
        JapiClient.setProjectJavaPath("modules/negotiatemeeting/negotiatemeeting-consumer");//主项目位置
        JapiClient.setActionReletivePath("com/bjike/goddess/negotiatemeeting/action");//主项目action位置
        JapiClient.setIncludeProjectJavaPath(new String[]{//关联项目
                "modules/negotiatemeeting/negotiatemeeting-api",
