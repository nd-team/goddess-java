...
public class ProjectWeekSerImpl extends ServiceImpl<ProjectWeek, ProjectWeekDTO> implements ProjectWeekSer {
    ...
    public ProjectWeekBO save(ProjectWeekTO to) throws SerException {
        ...
        for (ProjectWeekCountBO bo : list) {
            ...
            BeanUtils.copyProperties(bo, projectMonthTO);
                    ...
                    for (Integer month : months) {
                        for (Double price : prices) {
                            for (ProjectWeek projectWeek : list) {
                                if (projectWeek.getArrival().equals(arrival) && projectWeek.getProject().equals(project) && projectWeek.getYear() == year && projectWeek.getMonth() == month && projectWeek.getPrice() == price) {
                    ...
                    for (Integer month : months) {
                        for (Double price : prices) {
                            for (ProjectWeek a : list) {
                                if (a.getArrival().equals(arrival) && a.getYear() == year && a.getMonth() == month && a.getPrice() == price) {
