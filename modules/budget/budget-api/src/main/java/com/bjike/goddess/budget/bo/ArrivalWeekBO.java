 ...
 * @Description: [ 地区收入周业务传输对象 ]
 * @Version: [ v1.0.0 ]
 * @Copy: [ com.bjike ]
 */
public class ArrivalWeekBO extends BaseBO {
...
//    public String getArrivalMonthId() {
//        return arrivalMonthId;
//    }
//
//    public void setArrivalMonthId(String arrivalMonthId) {
//        this.arrivalMonthId = arrivalMonthId;
//    }
}