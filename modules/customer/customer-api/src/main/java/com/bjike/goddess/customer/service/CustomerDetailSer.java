...
public interface CustomerDetailSer extends Ser<CustomerDetail, CustomerDetailDTO> {
     ...
     */
    default List<CustomerDetailBO> listCustomerDetail(CustomerDetailDTO customerDetailDTO) throws SerException {
     ...
     * @return class CustomerDetailBO
     */
    default CustomerDetailBO addCustomerDetail(CustomerDetailTO customerDetailTO) throws SerException {
        return null;
    }
     ...
     * @return class CustomerDetailBO
     */
    default CustomerDetailBO editCustomerDetail(CustomerDetailTO customerDetailTO) throws SerException {
        return null;
    }
     ...
     * @param id id
     */
    default void deleteCustomerDetail(String id) throws SerException {
        return;
    }
     ...
     * @return class CustomerDetailBO
     */
    default CustomerDetailBO getCustomerDetailById(String id) throws SerException {
        return null;
    }
