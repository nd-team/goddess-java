 ...
 * @Copy: [ com.bjike ]
 */
public class CustomerWeightFirstFactorTO extends BaseTO {

    /**
     * 职权职权比
     */
    @NotNull(message = "职权职权比不能为空",groups = {ADD.class,EDIT.class})
    private Double funPowersFunPowers;

    /**
     * 职权时效性比
     */
    @NotNull(message = "职权时效性比不能为空",groups = {ADD.class,EDIT.class})
    private Double funPowersTimeliness;

    /**
     * 职权亲密度比
     */
    @NotNull(message = "职权亲密度比不能为空",groups = {ADD.class,EDIT.class})
    private Double funPowersCloseness;

    /**
     * 职权难易度比
     */
    @NotNull(message = "职权难易度比不能为空",groups = {ADD.class,EDIT.class})
    private Double funPowersDiffLevel;

    /**
     * 时效性职权比
     */
    @NotNull(message = "时效性职权比不能为空",groups = {ADD.class,EDIT.class})
    private Double timelinessFunPowers;

    /**
     * 时效性时效性比
     */
    @NotNull(message = "时效性时效性比不能为空",groups = {ADD.class,EDIT.class})
    private Double timelinessTimeliness;

    /**
     * 时效性亲密度比
     */
    @NotNull(message = "时效性亲密度比不能为空",groups = {ADD.class,EDIT.class})
    private Double timelinessCloseness;

    /**
     * 时效性难易度比
     */
    @NotNull(message = "时效性难易度比不能为空",groups = {ADD.class,EDIT.class})
    private Double timelinessDiffLevel;

    /**
     * 亲密度职权比
     */
    @NotNull(message = "亲密度职权比不能为空",groups = {ADD.class,EDIT.class})
    private Double closenessFunPowers;

    /**
     * 亲密度时效性比
     */
    @NotNull(message = "亲密度时效性比不能为空",groups = {ADD.class,EDIT.class})
    private Double closenessTimeliness;

    /**
     * 亲密度亲密度比
     */
    @NotNull(message = "亲密度亲密度比不能为空",groups = {ADD.class,EDIT.class})
    private Double closenessCloseness;

    /**
     * 亲密度难易度比
     */
    @NotNull(message = "亲密度难易度比不能为空",groups = {ADD.class,EDIT.class})
    private Double closenessDiffLevel;

    /**
     * 难易度职权比
     */
    @NotNull(message = "难易度职权比不能为空",groups = {ADD.class,EDIT.class})
    private Double diffLevelFunPowers;

    /**
     * 难易度时效性比
     */
    @NotNull(message = "难易度时效性比不能为空",groups = {ADD.class,EDIT.class})
    private Double diffLevelTimeliness;

    /**
     * 难易度亲密度比
     */
    @NotNull(message = "难易度亲密度比不能为空",groups = {ADD.class,EDIT.class})
    private Double diffLevelCloseness;

    /**
     * 难易度难易度比
     */
    @NotNull(message = "难易度难易度比不能为空",groups = {ADD.class,EDIT.class})
