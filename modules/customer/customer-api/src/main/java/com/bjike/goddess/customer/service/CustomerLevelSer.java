...
public interface CustomerLevelSer extends Ser<CustomerLevel, CustomerLevelDTO> {
     ...
     */
    default List<CustomerLevelBO> listCustomerLevel(CustomerLevelDTO customerLevelDTO) throws SerException {
     ...
     * @return class CustomerLevelBO
     */
    default CustomerLevelBO addCustomerLevel(CustomerLevelTO customerLevelTO) throws SerException {
        return null;
    }
     ...
     * @return class CustomerLevelBO
     */
    default CustomerLevelBO editCustomerLevel(CustomerLevelTO customerLevelTO) throws SerException {
        return null;
    }
     ...
     * @param id id
     */
    default void deleteCustomerLevel(String id) throws SerException {
        return;
    }
     ...
     * @param id id
     */
    default void congealCustomerLevel(String id) throws SerException {
        return;
    }
     ...
     * @param id id
     */
    default void thawCustomerLevel(String id) throws SerException {
        return;
    }
