 ...
 * @Copy: [ com.bjike ]
 */
public class CustomerBaseInfoBO extends BaseBO {
     ...
     * 客户级别
     */
    private CustomerLevelBO customerLevelBO;
    ...
    public CustomerLevelBO getCustomerLevelBO() {
        return customerLevelBO;
    }

    public void setCustomerLevelBO(CustomerLevelBO customerLevelBO) {
        this.customerLevelBO = customerLevelBO;
    }
