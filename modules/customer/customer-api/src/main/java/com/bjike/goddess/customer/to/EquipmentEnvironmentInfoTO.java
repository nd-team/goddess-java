 ...
 * @Copy: [ com.bjike ]
 */
public class EquipmentEnvironmentInfoTO extends BaseTO {
     ...
     * 业主客户信息
     */
    private String customerAndOwnerName;

    public String getCustomerAndOwnerName() {
        return customerAndOwnerName;
    }

    public void setCustomerAndOwnerName(String customerAndOwnerName) {
        this.customerAndOwnerName = customerAndOwnerName;
    }
