 ...
 * @Description: [ 设备搭建环境信息表现层对象 ]
 * @Version: [ v1.0.0 ]
 * @Copy: [ com.bjike ]
 */
public class EquipmentEnvironmentInfoVO {
     ...
     * 业主客户信息
     */
    private CustomerAndOwnerInfoVO customerAndOwnerInfoVO;

    public CustomerAndOwnerInfoVO getCustomerAndOwnerInfoVO() {
        return customerAndOwnerInfoVO;
    }

    public void setCustomerAndOwnerInfoVO(CustomerAndOwnerInfoVO customerAndOwnerInfoVO) {
        this.customerAndOwnerInfoVO = customerAndOwnerInfoVO;
    }
