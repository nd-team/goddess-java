 ...
 * @Copy: [ com.bjike ]
 */
public class CustomerBaseInfoExportTemple extends BaseBO {
    ...
    private String customerSatisfation;
    /**
     * 客户对我司合作满意程度
     */
    @ExcelHeader(name = "客户对我司合作满意程度")
    private String satisfationWithCompany;
    /**
     * 扣分事项
     */
    ...
    public String getContactPhace() {
        return contactPhace;
    }

    public void setContactPhace(String contactPhace) {
    ...
    public String getCustomerSatisfation() {
        return customerSatisfation;
    }

    public void setCustomerSatisfation(String customerSatisfation) {
        this.customerSatisfation = customerSatisfation;
    }

    public String getSatisfationWithCompany() {
        return satisfationWithCompany;
    }

    public void setSatisfationWithCompany(String satisfationWithCompany) {
