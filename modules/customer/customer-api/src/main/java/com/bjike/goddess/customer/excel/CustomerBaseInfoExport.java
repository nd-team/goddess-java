 ...
 * @Description: [ 客户基本信息导出 ]
 * @Version: [ v1.0.0 ]
 * @Copy: [ com.bjike ]
 */
public class CustomerBaseInfoExport extends BaseBO {

    /**
     * 第几个客户排序
     */
    @ExcelHeader(name = "第几个客户排序",notNull = true)
     ...
     * 最近一次更新人
     */
    @ExcelHeader(name = "最近一次更新人",notNull = true)
