...
/**
* 亲密度因素层权重持久化接口, 继承基类可使用ｊｐａ命名查询
* @Author:			[ lijuntao ]
* @Date:			[  2017-11-01 02:09 ]
* @Description:	[ 亲密度因素层权重持久化接口, 继承基类可使用ｊｐａ命名查询 ]
* @Version:		[ v1.0.0 ]
* @Copy:   		[ com.bjike ]
*/
public interface ClosenessFoactorWeightRep extends JpaRep<ClosenessFoactorWeight ,ClosenessFoactorWeightDTO> { 
