...
/**
* 职权因素层设置持久化接口, 继承基类可使用ｊｐａ命名查询
* @Author:			[ lijuntao ]
* @Date:			[  2017-11-01 11:37 ]
* @Description:	[ 职权因素层设置持久化接口, 继承基类可使用ｊｐａ命名查询 ]
* @Version:		[ v1.0.0 ]
* @Copy:   		[ com.bjike ]
*/
public interface FunPowerWeightFactorRep extends JpaRep<FunPowerWeightFactor ,FunPowerWeightFactorDTO> { 
