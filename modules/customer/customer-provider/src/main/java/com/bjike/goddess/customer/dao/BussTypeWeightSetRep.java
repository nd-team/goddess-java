...
/**
* 业务类型权重设置持久化接口, 继承基类可使用ｊｐａ命名查询
* @Author:			[ lijuntao ]
* @Date:			[  2017-11-01 10:24 ]
* @Description:	[ 业务类型权重设置持久化接口, 继承基类可使用ｊｐａ命名查询 ]
* @Version:		[ v1.0.0 ]
* @Copy:   		[ com.bjike ]
*/
public interface BussTypeWeightSetRep extends JpaRep<BussTypeWeightSet ,BussTypeWeightSetDTO> { 
