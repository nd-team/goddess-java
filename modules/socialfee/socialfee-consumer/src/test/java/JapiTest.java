...
//        JapiClient.delete(true);
        ...
        JapiClient.setProjectJavaPath("modules/socialfee/socialfee-consumer");//主项目位置
        JapiClient.setActionReletivePath("com/bjike/goddess/socialfee/action");//主项目action位置
        JapiClient.setIncludeProjectJavaPath(new String[]{//关联项目
                "modules/socialfee/socialfee-api",
