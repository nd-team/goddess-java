...
public class SocialFeeTO extends BaseTO {
     ...
     * 缴费所属年
     */
    @NotBlank(groups = {TestAdd.class,TestVoucher.class},message = "缴费所属年不能为空")
    private String payTimeYear;

    /**
     * 缴费所属月
     */
    @NotBlank(groups = {TestAdd.class,TestVoucher.class}, message = "缴费所属月不能为空")
    private String payTimeMonth;

    /**
     * 缴费所属时期
     */
    @NotBlank(groups = {TestVoucher.class}, message = "缴费所属时期不能为空")
    private String payTime;

    /**
     * 纳税人名称
     */
    @NotBlank(groups = {TestAdd.class} ,message = "纳税人名称不能为空")
    private String payFeer;

    /**
     * 单位社保号
     */
    @NotBlank(groups = {TestAdd.class} ,message = "单位社保号不能为空")
    private String workSocalNum;

    /**
     * 姓名
     */
    @NotBlank(groups = {TestAdd.class,TestVoucher.class} ,message = "姓名不能为空")
    private String empName;

    /**
     * 身份证明号码
     */
    @NotBlank(groups = {TestAdd.class} ,message = "身份证明号码不能为空")
    private String cardNum;

    /**
     * 证件号
     */
    @NotBlank(groups = {TestAdd.class} ,message = "证件号不能为空")
     ...
     * 基本养老保险单位
     */
    @NotNull(groups = {TestAdd.class} ,message = "基本养老保险单位不能为空,默认填0")
    private Double baseWork;

    /**
     * 基本养老保险个人
     */
    @NotNull(groups = {TestAdd.class} ,message = "基本养老保险个人不能为空,默认填0")
    private Double baseEmp;

    /**
     * 工伤保险计费工资
     */
    @NotNull(groups = {TestAdd.class} ,message = "工伤保险计费工资不能为空,默认填0")
    private Double injurySalary;

    /**
     * 工伤保险单位
     */
    @NotNull(groups = {TestAdd.class} ,message = "工伤保险单位不能为空,默认填0")
    private Double injuryWork;

    /**
     * 工伤保险个人
     */
    @NotNull(groups = {TestAdd.class} ,message = "工伤保险个人不能为空,默认填0")
    private Double injuryEmp;

    /**
     * 失业保险计费工资
     */
    @NotNull(groups = {TestAdd.class} ,message = "失业保险计费工资不能为空,默认填0")
    private Double unemploySalary;

    /**
     * 失业保险单位
     */
    @NotNull(groups = {TestAdd.class} ,message = "失业保险单位不能为空,默认填0")
    private Double unemployWork;

    /**
     * 失业保险个人
     */
    @NotNull(groups = {TestAdd.class} ,message = "失业保险个人不能为空,默认填0")
    private Double unemployEmp;

    /**
     * 社会医疗保险计费工资
     */
    @NotNull(groups = {TestAdd.class} ,message = "社会医疗保险计费工资不能为空,默认填0")
    private Double socialMediSalary;

    /**
     * 社会医疗保险单位
     */
    @NotNull(groups = {TestAdd.class} ,message = "社会医疗保险单位不能为空,默认填0")
    private Double socialMediWork;

    /**
     * 社会医疗保险个人
     */
    @NotNull(groups = {TestAdd.class} ,message = "社会医疗保险个人不能为空,默认填0")
    private Double socialMediEmp;

    /**
     * 重大疾病医疗补助计费工资
     */
    @NotNull(groups = {TestAdd.class} ,message = "重大疾病医疗补助计费工资不能为空,默认填0")
    private Double illSalary;

    /**
     * 重大疾病医疗补助单位
     */
    @NotNull(groups = {TestAdd.class} ,message = "重大疾病医疗补助单位不能为空,默认填0")
    private Double illWork;

    /**
     * 重大疾病医疗补助个人
     */
    @NotNull(groups = {TestAdd.class} ,message = "重大疾病医疗补助个人不能为空,默认填0")
    private Double illEmp;

    /**
     * 生育保险计费工资
     */
    @NotNull(groups = {TestAdd.class} ,message = "生育保险计费工资不能为空,默认填0")
    private Double pregnantSalary;

    /**
     * 生育保险单位
     */
    @NotNull(groups = {TestAdd.class} ,message = "生育保险单位不能为空,默认填0")
    private Double pregnantWork;

    /**
     * 生育保险个人
     */
    @NotNull(groups = {TestAdd.class} ,message = "生育保险个人不能为空,默认填0")
