...
import com.bjike.goddess.staffentry.entity.CusPermission;
...
public interface CusPermissionSer extends Ser<CusPermission, CusPermissionDTO> {
    ...
    /**
     * 根据idFlag查询只有模块的才可以进行添加编辑删除操作
     *
     * @param idFlag 客户权限idFlag
     * @throws SerException
     */
    default Boolean moudleCusPermission(String idFlag) throws SerException {
        return null;
    }
