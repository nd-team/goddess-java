 ...
 * @Copy: [ com.bjike ]
 */
public class BusinessContractMoneyTO extends BaseTO {
     ...
     * 预估市场亏损金额
     */
    @NotNull(message = "预估市场亏损金额",groups = {EDIT.class})
    private Double estimatedMarketLosses;

    /**
     * 预估确认担保人
     */
    @NotNull(message = "预估确认担保人",groups = {EDIT.class})
    private String guarantor;

    /**
     * 预估确认担保人审核意见
     */
    @NotNull(message = "预估确认担保人审核意见",groups = {EDIT.class})
    private String guarantorIdea;

    /**
     * 预估项目是否确认实施
     */
    @NotNull(message = "预估项目是否确认实施",groups = {EDIT.class})
    private Boolean implement;

    /**
     * 项目经理意见
     */
    @NotNull(message = "项目经理意见", groups = {EDIT.class})
    private String managerIdea;

    /**
     * 规划模块分析意见
     */
    @NotNull(message = "规划模块分析意见", groups = {EDIT.class})
    private String planIdea;

    /**
     * 预算模块分析意见
     */
    @NotNull(message = "预算模块分析意见", groups = {EDIT.class})
