 ...
 * @Copy: [ com.bjike ]
 */
public class SurveyQuestionnairesTO extends BaseTO {
...
//    @NotNull(message = "调研实施id不能为空", groups = {ADD.class, EDIT.class})
     ...
     * 调研表问题选项
     */
    private List<SurveyQuestionnaireOptionTO> surveyQuestionnaireOptionTOs;
    ...
    public List<SurveyQuestionnaireOptionTO> getSurveyQuestionnaireOptionTOs() {
        return surveyQuestionnaireOptionTOs;
    }

    public void setSurveyQuestionnaireOptionTOs(List<SurveyQuestionnaireOptionTO> surveyQuestionnaireOptionTOs) {
        this.surveyQuestionnaireOptionTOs = surveyQuestionnaireOptionTOs;
    }
}