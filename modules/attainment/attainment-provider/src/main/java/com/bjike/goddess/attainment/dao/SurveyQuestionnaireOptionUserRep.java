...
/**
* 问卷填写信息表持久化接口, 继承基类可使用ｊｐａ命名查询
* @Author:			[ dengjunren ]
* @Date:			[  2017-04-06 11:35 ]
* @Description:	[ 问卷填写信息表持久化接口, 继承基类可使用ｊｐａ命名查询 ]
* @Version:		[ v1.0.0 ]
* @Copy:   		[ com.bjike ]
*/
public interface SurveyQuestionnaireOptionUserRep extends JpaRep<SurveyQuestionnaireOptionUser ,SurveyQuestionnaireOptionUserDTO> { 
