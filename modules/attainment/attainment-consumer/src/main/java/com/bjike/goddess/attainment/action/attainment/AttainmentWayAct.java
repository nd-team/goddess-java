...
public class AttainmentWayAct {
     ...
     */
    @PostMapping("v1/save")
    public Result save(@Validated(ADD.class) AttainmentWayTO to, BindingResult result) throws ActException {
        try {
    ...
    public Result update(@Validated(EDIT.class) AttainmentWayTO to, BindingResult result) throws ActException {
        try {
    ...
    public Result guidePermission(@Validated(GuidePermissionTO.TestAdd.class) GuidePermissionTO guidePermissionTO, BindingResult bindingResult, HttpServletRequest request) throws ActException {
        try {
            ...
            Boolean isHasPermission = attainmentWayAPI.guidePermission(guidePermissionTO);
            if (!isHasPermission) {
                //int code, String msg
