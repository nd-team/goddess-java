...
public class SalaryConfirmRecordTO extends BaseTO {
     ...
     * 是否入职
     */
    @NotNull(message = "是否入职不能为空!", groups = {ADD.class, EDIT.class})
     ...
     * 籍贯
     */
    @NotBlank(message = "籍贯不能为空!", groups = {ADD.class, EDIT.class})
     ...
     * 是否已确认
     */
    @NotNull(message = "是否已确认不能为空!", groups = {ADD.class, EDIT.class})
