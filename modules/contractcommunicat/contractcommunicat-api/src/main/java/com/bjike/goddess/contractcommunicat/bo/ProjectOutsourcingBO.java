 ...
 * @Copy: [ com.bjike ]
 */
public class ProjectOutsourcingBO extends BaseBO {
    ...
    public ProjectOutsourcingBO() {
    }

    public ProjectOutsourcingBO(String contractExtProject, String outsourcingProject,String contractInProject, String communicateTimes,
