...
public class BusinessNegotiation extends BaseEntity {
     ...
     * 内部项目编号
     */
    @Column(name = "projectNum",  columnDefinition = "VARCHAR(255)   COMMENT '内部项目编号'")
     ...
     * 问题受理编号(对内)
     */
    @Column(name = "problemNum",  columnDefinition = "VARCHAR(255)   COMMENT '问题受理编号(对内)'")
    private String problemNum;

    /**
     * 问题归属
     */
    @Column(name = "problemBelong",  columnDefinition = "VARCHAR(255)   COMMENT '问题归属'")
    private String problemBelong;

    /**
     * 洽谈轮次
     */
    @Column(name = "rounds",  columnDefinition = "INT(255)   COMMENT '洽谈轮次'")
    private Integer rounds;

    /**
     * 计划洽谈时间
     */
    @Column(name = "planNegotiationTime",  columnDefinition = "DATE   COMMENT '计划洽谈时间'")
    private LocalDate planNegotiationTime;

    /**
     * 实际洽谈时间
     */
    @Column(name = "practiceNegotiationTime",  columnDefinition = "DATE   COMMENT '实际洽谈时间'")
    private LocalDate practiceNegotiationTime;

    /**
     * 洽谈人
     */
    @Column(name = "discussPeople",  columnDefinition = "VARCHAR(255)   COMMENT '洽谈人'")
     ...
     * 洽谈公司
     */
    @Column(name = "discussCompany",  columnDefinition = "VARCHAR(255)   COMMENT '洽谈公司'")
    private String discussCompany;

    /**
     * 洽谈对象
     */
    @Column(name = "discussObject",  columnDefinition = "VARCHAR(255)   COMMENT '洽谈对象'")
    private String discussObject;

    /**
     * 洽谈方式
     */
    @Column(name = "discussWay",  columnDefinition = "VARCHAR(255)   COMMENT '洽谈方式'")
    private String discussWay;

    /**
     * 洽谈地点
     */
    @Column(name = "discussPlace",  columnDefinition = "VARCHAR(255)   COMMENT '洽谈地点'")
    private String discussPlace;

    /**
     * 问题归类
     */
    @Column(name = "problemCategorize",  columnDefinition = "VARCHAR(255)   COMMENT '问题归类'")
    private String problemCategorize;

    /**
     * 洽谈内容
     */
    @Column(name = "discussContent",  columnDefinition = "VARCHAR(255)   COMMENT '洽谈内容'")
    private String discussContent;

    /**
     * 洽谈目的
     */
    @Column(name = "discussIdea",  columnDefinition = "VARCHAR(255)   COMMENT '洽谈目的'")
    private String discussIdea;

    /**
     * 是否有洽谈准备
     */
    @Column(name = "is_discussPrepare",  columnDefinition = "TINYINT(1)  DEFAULT 0  COMMENT '是否有洽谈准备'", insertable = false)
    private Boolean discussPrepare;

    /**
     * 涉及金额
     */
    @Column(name = "amountInvolved",  columnDefinition = "VARCHAR(255)   COMMENT '涉及金额'")
    private String amountInvolved;

    /**
     * 是否洽谈
     */
    @Column(name = "is_discuss",  columnDefinition = "TINYINT(1)  DEFAULT 0  COMMENT '是否洽谈'", insertable = false)
    private Boolean discuss;

    /**
     * 洽谈结果
     */
    @Column(name = "discussResult",  columnDefinition = "VARCHAR(255)   COMMENT '洽谈结果'")
    private String discussResult;

    /**
     * 是否达到洽谈目的
     */
    @Column(name = "is_attainDiscussIdea",  columnDefinition = "TINYINT(1)  DEFAULT 0  COMMENT '是否达到洽谈目的'", insertable = false)
    private Boolean attainDiscussIdea;

    /**
     * 是否有洽谈到其他问题
     */
    @Column(name = "is_discussProblem",  columnDefinition = "TINYINT(1)  DEFAULT 0  COMMENT '是否有洽谈到其他问题'", insertable = false)
    private Boolean discussProblem;

    /**
     * 话题记录
     */
    @Column(name = "subjectRecord",  columnDefinition = "VARCHAR(255)   COMMENT '话题记录'")
    private String subjectRecord;

    /**
     * 是否有录音
     */
    @Column(name = "is_soundRecord",  columnDefinition = "TINYINT(1)  DEFAULT 0  COMMENT '是否有录音'", insertable = false)
    private Boolean soundRecord;

    /**
     * 是否转入合同管理-已立项
     */
    @Column(name = "is_hasProject",  columnDefinition = "TINYINT(1)  DEFAULT 0  COMMENT '是否转入合同管理-已立项'", insertable = false)
    private Boolean hasProject;

    /**
     * 是否转入合同管理-市场费用
     */
    @Column(name = "is_marketCost",  columnDefinition = "TINYINT(1)  DEFAULT 0  COMMENT '是否转入合同管理-市场费用'", insertable = false)
    private Boolean marketCost;

    /**
     * 是否转换市场招待
     */
    @Column(name = "is_marketFor",  columnDefinition = "TINYINT(1)  DEFAULT 0  COMMENT '是否转换市场招待'", insertable = false)
    private Boolean marketFor;

    /**
     * 是否持续跟进
     */
    @Column(name = "is_continueFollowUp",  columnDefinition = "TINYINT(1)  DEFAULT 0  COMMENT '是否持续跟进'", insertable = false)
    private Boolean continueFollowUp;

    /**
     * 是否闭环
     */
    @Column(name = "is_closedLoop",  columnDefinition = "TINYINT(1)  DEFAULT 0  COMMENT '是否闭环'", insertable = false)
    private Boolean closedLoop;

    /**
     * 是否需要协助
     */
    @Column(name = "is_needAssist",  columnDefinition = "TINYINT(1)  DEFAULT 0  COMMENT '是否需要协助'", insertable = false)
    private Boolean needAssist;

    /**
     * 需协助部门
     */
    @Column(name = "assistDept",  columnDefinition = "VARCHAR(255)   COMMENT '需协助部门'")
     ...
     * 是否已发协助函
     */
    @Column(name = "is_assistLetter",  columnDefinition = "TINYINT(1)  DEFAULT 0  COMMENT '是否已发协助函'", insertable = false)
    private Boolean assistLetter;

    /**
     * 协助函单号
     */
    @Column(name = "assistLetterNum",  columnDefinition = "VARCHAR(255)   COMMENT '协助函单号'")
    private String assistLetterNum;

    /**
     * 计划跟进时间
     */
    @Column(name = "planFollowUp",  columnDefinition = "DATE   COMMENT '计划跟进时间'")
    private LocalDate planFollowUp;

    /**
     * 是否产生路费
     */
    @Column(name = "is_produceTrip",  columnDefinition = "TINYINT(1)  DEFAULT 0  COMMENT '是否产生路费'", insertable = false)
    private Boolean produceTrip;

    /**
     * 路费
     */
    @Column(name = "trip",  columnDefinition = "DECIMAL(10,2)   COMMENT '路费'")
    private Double trip;

    /**
     * 谈判技巧库id
     */
    @Column(name = "skillLibraryId",  columnDefinition = "VARCHAR(48)  COMMENT '谈判技巧库id'")
    private String skillLibraryId;
    ...
    public String getSkillLibraryId() {
        return skillLibraryId;
    }

    public void setSkillLibraryId(String skillLibraryId) {
        this.skillLibraryId = skillLibraryId;
    }
}