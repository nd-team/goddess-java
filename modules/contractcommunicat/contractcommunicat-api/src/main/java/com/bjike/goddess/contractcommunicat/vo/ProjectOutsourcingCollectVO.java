 ...
 * @Copy: [ com.bjike ]
 */
public class ProjectOutsourcingCollectVO extends BaseBO {
    ...
    public ProjectOutsourcingCollectVO() {
    }

    public ProjectOutsourcingCollectVO(String outsourcingProject, String contractExtProject,
                                       ...
                                       String abandon, CommunicateResult projectResult) {
        this.outsourcingProject = outsourcingProject;
        this.contractExtProject = contractExtProject;
        this.contractInProject = contractInProject;
        this.communicateTimes = communicateTimes;
