            ...
            for (int i = 0; i <= list.size();i++) {
                ...
                for (int a = 0; a < areaSubjectBOS.size();a++){
                    ...
                    for (int b = 0; b < departmentSubjectBOS.size();b++){
                        ...
                        List<SubjectCollectBO> subjectCollectBOS = departmentSubjectBOS.get(b).getSubjectCollectList();
                        for (SubjectCollectBO subjectCollectBO : subjectCollectBOS){
                            subjectIntroExport.setProject(subjectCollectBO.getProject());
                            subjectIntroExport.setBeginBorrowMoney(subjectCollectBO.getBeginBorrowMoney());
                            subjectIntroExport.setBeginLoanMoney(subjectCollectBO.getBeginLoanMoney());
                            subjectIntroExport.setCurrentBorrowMoney(subjectCollectBO.getCurrentBorrowMoney());
                            subjectIntroExport.setCurrentLoanMoney(subjectCollectBO.getCurrentLoanMoney());
                            subjectIntroExport.setEndBorrowMoney(subjectCollectBO.getEndBorrowMoney());
                            subjectIntroExport.setEndLoanMoney(subjectCollectBO.getEndLoanMoney());
                            subjectIntroExports.add(subjectIntroExport);
                        }
                        firstSubjectNumber = subjectCollectBOS.size();
        ...
        for (String area : areas) {
            ...
            for (String department : departments) {
                ...
                for (String project : projects) {
                    ...
                    subjectCollectBO.setProject(project);
                    subjectCollectBO.setBeginBorrowMoney(beginBorrowMoney);
                    subjectCollectBO.setBeginLoanMoney(beginLoanMoney);
                    subjectCollectBO.setCurrentBorrowMoney(currentBorrowMoney);
                    subjectCollectBO.setCurrentLoanMoney(currentLoanMoney);
                    subjectCollectBO.setEndBorrowMoney(endBorrowMoney);
                    subjectCollectBO.setEndLoanMoney(endLoanMoney);
                    subjectCollectBO.setCurrentYearBorrowMoney(currentYearBorrowMoney);
                    subjectCollectBO.setCurrentLoanMoney(currentLoanMoney);
                    subjectCollectBOS.add(subjectCollectBO);
                }
                departmentSubjectBO.setDepartment(department);
                departmentSubjectBO.setSubjectCollectList(subjectCollectBOS);
