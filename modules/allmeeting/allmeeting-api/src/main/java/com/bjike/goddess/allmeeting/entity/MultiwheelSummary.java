 ...
 */
@Entity
@Table(name = "allmeeting_multiwheelsummary")
public class MultiwheelSummary extends BaseEntity {
     ...
     * 会议所属部门
     */
    @Column(name = "department", columnDefinition = "VARCHAR(255)   COMMENT '会议所属部门'")
