 ...
 */
@Entity
@Table(name = "allmeeting_concisepermission")
public class ConcisePermission extends BaseEntity {

    /**
     * 员工编号
     */
    @Column(name = "userNum", nullable = false, unique = true, columnDefinition = "VARCHAR(255)   COMMENT '员工编号'")
