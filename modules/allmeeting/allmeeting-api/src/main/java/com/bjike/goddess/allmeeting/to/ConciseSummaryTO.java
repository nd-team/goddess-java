 ...
 * @Copy: [ com.bjike ]
 */
public class ConciseSummaryTO extends BaseTO {


    /**
     * 实际会议时间
     */
    @NotBlank(message = "实际会议时间不能为空", groups = {ADD.class, EDIT.class})
     ...
     * 会议所属模块
     */
    @NotBlank(message = "会议所属模块不能为空", groups = {ADD.class, EDIT.class})
