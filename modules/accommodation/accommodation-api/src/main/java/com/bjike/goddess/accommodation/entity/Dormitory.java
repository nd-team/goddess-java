 ...
 */
@Entity
@Table(name = "accommodation_dormitory")
public class Dormitory extends BaseEntity {
    /**
     * 项目
     */
    @Column(nullable = false,columnDefinition = "VARCHAR(255) COMMENT '项目'")
     ...
     * 宿舍地址
     */
    @Column(nullable = false,columnDefinition = "VARCHAR(255) COMMENT '宿舍地址'")
    private String dormitoryAddress;
    /**
     * 宿舍钥匙数量（把）
     */
    @Column(nullable = false,columnDefinition = "VARCHAR(255) COMMENT '宿舍钥匙数量（把）'")
    private String keysNumber;
    /**
     * 宿舍钥匙分配情况
     */
    @Column(nullable = false,columnDefinition = "VARCHAR(255) COMMENT '宿舍钥匙分配情况'")
    private String keysDistribution;
    /**
     * 宿舍负责人
     */
    @Column(nullable = false,columnDefinition = "VARCHAR(255) COMMENT '宿舍负责人'")
    private String head;
    /**
     * 负责人联系方式
     */
    @Column(nullable = false,columnDefinition = "VARCHAR(255) COMMENT '负责人联系方式'")
    private String headContact;
    /**
     * 宿舍床位数量（个）
     */
    @Column(nullable = false,columnDefinition = "VARCHAR(255) COMMENT '宿舍床位数量（个）'")
    private String berth;
    /**
     * 已入住床位（个）
     */
    @Column(nullable = false,columnDefinition = "VARCHAR(255) COMMENT '已入住床位（个）'")
    private String beeBerth;
    /**
     * 闲置床位（个）
     */
    @Column(nullable = false,columnDefinition = "VARCHAR(255) COMMENT '闲置床位（个）'")
    private String idleBerth;
    /**
     * 宿舍床上3件套数量（件）
     */
    @Column(nullable = false,columnDefinition = "VARCHAR(255) COMMENT '宿舍床上3件套数量（件）'")
    private String suit;
    /**
     * 已领用数量（件）
     */
    @Column(nullable = false,columnDefinition = "VARCHAR(255) COMMENT '已领用数量（件）'")
    private String recipientsSuit;
    /**
     * 闲置数量（件）
     */
    @Column(nullable = false,columnDefinition = "VARCHAR(255) COMMENT '闲置数量（件）'")
    private String idleSuit;
    /**
     * 宿舍被褥数量（件）
     */
    @Column(nullable = false,columnDefinition = "VARCHAR(255) COMMENT '宿舍被褥数量（件）'")
