...
//            LocalDateTime date = marketInfoPreAnalysis.getCreateTime();
            MarketInfoPreAnalysis marketInfoPreAnalysis1 = BeanTransform.copyProperties(marketInfoRecordTO, MarketInfoPreAnalysis.class, true, "majors", "infoFillPerson");
            BeanUtils.copyProperties(marketInfoPreAnalysis1,marketInfoPreAnalysis,"id","createTime");
