 ...
 */
@Entity
@Table(name = "market_marketinfopreanalysis")
public class MarketInfoPreAnalysis extends BaseEntity {
     ...
     * 信息来源
     */
    @Column(name = "sourceInfo", nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '信息来源'")
     ...
     * 初步分析时间
     */
    @Column(name = "preliminaryAnalyDate", columnDefinition = "DATE   COMMENT '初步分析时间'")
    private LocalDate preliminaryAnalyDate;

    /**
     * 是否有资金运营
     */
    @Column(name = "is_fundOperation", columnDefinition = "TINYINT(1)   COMMENT '是否有资金运营'")
    private Boolean fundOperation;

    /**
     * 技术人员是否能够提供
     */
    @Column(name = "is_ableProvide", columnDefinition = "TINYINT(1)  COMMENT '技术人员是否能够提供'")
    private Boolean ableProvide;

    /**
     * 合作方是否有合作风险
     */
    @Column(name = "is_partnerRisk", columnDefinition = "TINYINT(1)  COMMENT '合作方是否有合作风险'")
    private Boolean partnerRisk;

    /**
     * 风险描述
     */
    @Column(name = "riskDescribe", columnDefinition = "VARCHAR(255)   COMMENT '风险描述'")
    ...
    public LocalDate getPreliminaryAnalyDate() {
        return preliminaryAnalyDate;
    }

    public void setPreliminaryAnalyDate(LocalDate preliminaryAnalyDate) {
