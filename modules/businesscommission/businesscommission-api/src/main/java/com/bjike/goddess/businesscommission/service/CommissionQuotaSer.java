 ...
 * @Copy: [ com.bjike ]
 */
public interface CommissionQuotaSer extends Ser<CommissionQuota, CommissionQuotaDTO> {
     ...
     */
    default CommissionQuotaBO getOneById(String id) throws SerException {return null;}
     ...
     * @return class CommissionQuotaBO
     */
    default CommissionQuotaBO importExcel(List<CommissionQuotaTO> commissionQuotaTO) throws SerException { return null;}
