...
*/
@Entity
@Table(name = "oilcardmanage_serveroilcard")
public class ServerOilCard extends BaseEntity { 
...
* 卡号
*/
@Column(name = "cardNum",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '卡号'"  ) 
 private String  cardNum; 

/**
* 主卡/副卡
*/
@Column(name = "hostCard",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '主卡/副卡'"  ) 
 private String  hostCard; 

/**
* 所属主卡
*/
@Column(name = "mainCard",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '所属主卡'"  ) 
 private String  mainCard; 

/**
* 办理人
*/
@Column(name = "checker",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '办理人'"  ) 
 private String  checker; 

/**
* 办理日期
*/
@Column(name = "checkDate",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '办理日期'"  ) 
...
* 期初金额
*/
@Column(name = "money",nullable = false,columnDefinition = "DECIMAL(10,2)   COMMENT '期初金额'"  ) 
...
* 使用状态更新时间
*/
@Column(name = "editDate",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '使用状态更新时间'"  ) 
