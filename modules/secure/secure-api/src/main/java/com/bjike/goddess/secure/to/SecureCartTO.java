...
public class SecureCartTO extends BaseTO {
     ...
     * 社保卡管理分类
     */
    @NotNull(groups = {ADD.class, EDIT.class}, message = "社保卡管理分类不能为空")
     ...
     * 社保帐户号码
     */
    @NotBlank(groups = {ADD.class, EDIT.class}, message = "社保帐户号码不能为空")
    private String cartNum;

    /**
     * 领卡机构
     */
    @NotBlank(groups = {ADD.class, EDIT.class}, message = "领卡机构不能为空")
    private String institutions;

    /**
     * 物品状态
     */
    @NotBlank(groups = {ADD.class, EDIT.class}, message = "物品状态不能为空")
    private String status;

    /**
     * 储存位置
     */
    @NotBlank(groups = {ADD.class, EDIT.class}, message = "储存位置不能为空")
    private String location;

    /**
     * 曾补办时间
     */
//    @NotBlank(groups = {ADD.class, EDIT.class}, message = "曾补办时间不能为空")
    private String reapply;

    /**
     * 曾补办次数
     */
//    @NotNull(groups = {ADD.class, EDIT.class}, message = "曾补办次数不能为空")
//    @Min(value = 0, groups = {ADD.class, EDIT.class}, message = "曾补办次数必须大于等于0")
    private Integer reapplyNum;

    /**
     * 曾补办原因明细
     */
//    @NotBlank(groups = {ADD.class, EDIT.class}, message = "曾补办原因明细不能为空")
