...
/**
* 减员前持久化接口, 继承基类可使用ｊｐａ命名查询
* @Author:			[ chenjunhao ]
* @Date:			[  2017-04-24 09:45 ]
* @Description:	[ 减员前持久化接口, 继承基类可使用ｊｐａ命名查询 ]
* @Version:		[ v1.0.0 ]
* @Copy:   		[ com.bjike ]
*/
public interface BeforeRemoveEmployeeRep extends JpaRep<BeforeRemoveEmployee ,BeforeRemoveEmployeeDTO> { 
