 ...
 * @Description: [ 会议组织部分内容表现层对象 ]
 * @Version: [ v1.0.0 ]
 * @Copy: [ com.bjike ]
 */
public class MeetDesignVO {
     ...
     * 会议计划参与人员表现层对象
     */
    private List<AttenderVO> attenderVOs;
    ...
    public List<AttenderVO> getAttenderVOs() {
        return attenderVOs;
    }

    public void setAttenderVOs(List<AttenderVO> attenderVOs) {
        this.attenderVOs = attenderVOs;
    }
}