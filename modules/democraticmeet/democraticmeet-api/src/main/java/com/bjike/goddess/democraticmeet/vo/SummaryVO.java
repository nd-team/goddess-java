...
public class SummaryVO {
     ...
     * 民主生活会议组织内容
     */
    private DemocraticContentVO democraticContentVO;

    /**
     * 建议数据数组
     */
    private List<AdviceTableVO> adviceTableVOList;
    ...
    public DemocraticContentVO getDemocraticContentVO() {
        return democraticContentVO;
    }

    public void setDemocraticContentVO(DemocraticContentVO democraticContentVO) {
        this.democraticContentVO = democraticContentVO;
    }

    public List<AdviceTableVO> getAdviceTableVOList() {
        return adviceTableVOList;
    }

    public void setAdviceTableVOList(List<AdviceTableVO> adviceTableVOList) {
        this.adviceTableVOList = adviceTableVOList;
    }
}