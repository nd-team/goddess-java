...
public class JapiTest {
	...
	public static void main(String[] args) throws IOException {
		...
		JapiClient.setProjectJavaPath("modules/democraticmeet/democraticmeet-consumer");//主项目位置
		JapiClient.setActionReletivePath("com/bjike/goddess/democraticmeet/action");//主项目action位置
		JapiClient.setIncludeProjectJavaPath(new String[]{//关联项目
				"modules/democraticmeet/democraticmeet-api",
				"common/common-api"
		});
