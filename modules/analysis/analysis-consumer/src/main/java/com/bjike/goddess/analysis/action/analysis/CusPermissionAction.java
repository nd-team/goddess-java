...
import com.bjike.goddess.analysis.api.CusPermissionAPI;
import com.bjike.goddess.analysis.bo.CusOperateBO;
import com.bjike.goddess.analysis.bo.CusPermissionBO;
import com.bjike.goddess.analysis.dto.CusPermissionDTO;
import com.bjike.goddess.analysis.to.CusPermissionTO;
import com.bjike.goddess.analysis.vo.CusOperateVO;
import com.bjike.goddess.analysis.vo.CusPermissionVO;
...
public class CusPermissionAction {
     ...
     * 列表总条数
     *
     * @param cusPermissionDTO 收入成本分析权限信息dto
     * @des 获取所有收入成本分析权限信息总条数
     * @version v1
     */
    @GetMapping("v1/count")
     ...
     * 一个收入成本分析权限
     *
     * @param id 收入成本分析权限信息id
     * @return class CusPermissionVO
     * @des 根据id获取所有收入成本分析权限信息
     * @version v1
     */
     ...
     * 编辑收入成本分析权限
     *
     * @param cusPermissionTO 收入成本分析权限基本信息数据bo
     * @return class CusPermissionVO
     * @des 编辑收入成本分析权限
     * @version v1
     */
