...
//                JapiClient.delete(true);
        ...
        JapiClient.setProjectJavaPath("modules/staffmeeting/staffmeeting-consumer");//主项目位置
        JapiClient.setActionReletivePath("com/bjike/goddess/staffmeeting/action");//主项目action位置
        JapiClient.setIncludeProjectJavaPath(new String[]{//关联项目
                "modules/staffmeeting/staffmeeting-api",
                "common/common-api"
        });
