...
import com.bjike.goddess.business.api.CusPermissionAPI;
import com.bjike.goddess.business.bo.CusOperateBO;
...
import com.bjike.goddess.business.vo.CusOperateVO;
import com.bjike.goddess.business.vo.CusPermissionVO;
...
public class CusPermissionAction {
     ...
     * 列表总条数
     *
     * @param cusPermissionDTO 工商权限信息dto
     * @des 获取所有工商权限信息总条数
     * @version v1
     */
    @GetMapping("v1/count")
     ...
     * 编辑工商权限
     *
     * @param cusPermissionTO 工商权限基本信息数据bo
     * @return class CusPermissionVO
     * @des 编辑工商权限
     * @version v1
     */
