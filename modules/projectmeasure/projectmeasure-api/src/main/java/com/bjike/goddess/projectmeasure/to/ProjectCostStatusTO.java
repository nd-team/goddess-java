...
public class ProjectCostStatusTO extends BaseTO {
     ...
     * 税金
     */
    @NotNull(groups = {ADD.class, EDIT.class}, message = "税金必须是大于等于0的小数")
    private Double taxes;

    /**
     * 服务费用
     */
    @NotNull(groups = {ADD.class, EDIT.class}, message = "服务费必须是大于等于0的小数")
    private Double serviceCharge;

    /**
     * 提成
     */
    @NotNull(groups = {ADD.class, EDIT.class}, message = "提成必须是大于等于0的小数")
    private Double royalties;

    /**
     * 招待费
     */
    @NotNull(groups = {ADD.class, EDIT.class}, message = "招待费必须是大于等于0的小数")
    private Double serveCharge;

    /**
     * 需求费用
     */
    @NotNull(groups = {ADD.class, EDIT.class}, message = "需求费用必须是大于等于0的小数")
