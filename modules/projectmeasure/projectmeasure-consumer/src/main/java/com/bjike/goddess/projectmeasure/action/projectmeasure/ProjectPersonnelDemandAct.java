...
public class ProjectPersonnelDemandAct {
     ...
     */
    @GetMapping("v1/list")
    public Result list(@Validated ProjectPersonnelDemandDTO dto, BindingResult result, HttpServletRequest request) throws ActException {
        try {
     ...
     */
    @PostMapping("v1/add")
    public Result add(@Validated({ADD.class}) ProjectPersonnelDemandTO to, BindingResult result, HttpServletRequest request) throws ActException {
        try {
     ...
     */
    @PutMapping("v1/edit")
    public Result edit(@Validated({EDIT.class}) ProjectPersonnelDemandTO to, BindingResult result) throws ActException {
        try {
