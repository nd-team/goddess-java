...
//		JapiClient.delete(true);
		...
		JapiClient.setProjectJavaPath("modules/materialbuy/materialbuy-consumer");//主项目位置
		JapiClient.setActionReletivePath("com/bjike/goddess/materialbuy/action");//主项目action位置
