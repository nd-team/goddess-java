...
/**
* 股权交易记录持久化接口, 继承基类可使用ｊｐａ命名查询
* @Author:			[ lijuntao ]
* @Date:			[  2017-08-21 04:05 ]
* @Description:	[ 股权交易记录持久化接口, 继承基类可使用ｊｐａ命名查询 ]
* @Version:		[ v1.0.0 ]
* @Copy:   		[ com.bjike ]
*/
public interface EquityTransactRecordRep extends JpaRep<EquityTransactRecord,EquityTransactRecordDTO> {
