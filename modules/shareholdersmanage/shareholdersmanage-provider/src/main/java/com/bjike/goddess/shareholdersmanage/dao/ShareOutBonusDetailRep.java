...
/**
* 分红明细持久化接口, 继承基类可使用ｊｐａ命名查询
* @Author:			[ lijuntao ]
* @Date:			[  2017-08-21 05:55 ]
* @Description:	[ 分红明细持久化接口, 继承基类可使用ｊｐａ命名查询 ]
* @Version:		[ v1.0.0 ]
* @Copy:   		[ com.bjike ]
*/
public interface ShareOutBonusDetailRep extends JpaRep<ShareOutBonusDetail ,ShareOutBonusDetailDTO> { 
