...
* 类型名称
*/
@Column(name = "",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '类型名称'"  ) 
...
* 性别
*/
@Column(name = "",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '性别'"  ) 
...
* 持股数量
*/
@Column(name = "",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '持股数量'"  ) 
...
* 股东状态
*/
@Column(name = "",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '股东状态'"  ) 
