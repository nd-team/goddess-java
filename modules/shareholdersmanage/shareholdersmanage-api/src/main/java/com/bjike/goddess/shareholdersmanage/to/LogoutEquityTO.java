...
public class LogoutEquityTO extends BaseTO {
     ...
     * 注销股权数/万
     */
    @NotBlank(groups = {ADD.class,EDIT.class}, message = "注销股权数不能为空")
    private Integer logoutHoldNum;

    /**
     * 每股价格/元
     */
    @NotBlank(groups = {ADD.class,EDIT.class}, message = "每股价格不能为空")
    private Double perSharePrice;

    /**
     * 金额
     */
    @NotBlank(groups = {ADD.class,EDIT.class}, message = "金额不能为空")
