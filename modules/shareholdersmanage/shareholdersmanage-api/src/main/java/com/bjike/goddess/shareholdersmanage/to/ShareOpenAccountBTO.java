 ...
 * @Copy: [ com.bjike ]
 */
public class ShareOpenAccountBTO extends BaseTO {
     ...
     * 开户日期
     */
    @NotBlank(groups = {EDIT.class}, message = "开户日期不能为空")
    private String openDate;

    /**
     * 类型名称
     */
    @NotNull(groups = {EDIT.class}, message = "类型名称不能为空")
    private TypeName typeName;

    /**
     * 股东姓名
     */
    @NotBlank(groups = {EDIT.class}, message = "股东姓名不能为空")
    private String shareholderName;

    /**
     * 性别
     */
    @NotNull(groups = {EDIT.class}, message = "性别不能为空")
    private Gender gender;

    /**
     * 证件类型
     */
    @NotBlank(groups = {EDIT.class}, message = "证件类型不能为空")
    private String documentType;

    /**
     * 证件号码
     */
    @NotBlank(groups = {EDIT.class}, message = "证件号码不能为空")
    private String certifiID;

    /**
     * 联系住址
     */
    @NotBlank(groups = {EDIT.class}, message = "联系住址不能为空")
     ...
     * 出资方式
     */
    @NotBlank(groups = {EDIT.class}, message = "出资方式不能为空")
