...
//		JapiClient.delete(true);
        ...
        JapiClient.setProjectJavaPath("modules/shareholdersmanage/shareholdersmanage-consumer");//主项目位置
        JapiClient.setActionReletivePath("com/bjike/goddess/shareholdersmanage/action/");//主项目action位置
        JapiClient.setIncludeProjectJavaPath(new String[]{//关联项目
                "modules/shareholdersmanage/shareholdersmanage-api",
