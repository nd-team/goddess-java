...
import com.bjike.goddess.bidding.api.CusPermissionAPI;
import com.bjike.goddess.bidding.bo.CusOperateBO;
...
import com.bjike.goddess.bidding.vo.CusOperateVO;
import com.bjike.goddess.bidding.vo.CusPermissionVO;
...
public class CusPermissionAction {
     ...
     * 列表总条数
     *
     * @param cusPermissionDTO 招投标权限信息dto
     * @des 获取所有招投标权限信息总条数
     * @version v1
     */
    @GetMapping("v1/count")
     ...
     * 编辑招投标权限
     *
     * @param cusPermissionTO 招投标权限基本信息数据bo
     * @return class CusPermissionVO
     * @des 编辑招投标权限
     * @version v1
     */
