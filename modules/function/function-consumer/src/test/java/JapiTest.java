...
public class JapiTest {
	public static void main(String[] args) throws IOException {
		...
		JapiClient.setProjectJavaPath("modules/function/function-consumer");//主项目位置
		JapiClient.setActionReletivePath("com/bjike/goddess/function/action");//主项目action位置
		JapiClient.setIncludeProjectJavaPath(new String[]{//关联项目
				"modules/user/user-api",
				"modules/function/function-api",
				"common/common-api"
		});
