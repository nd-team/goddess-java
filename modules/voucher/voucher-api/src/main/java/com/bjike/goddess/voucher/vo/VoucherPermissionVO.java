 ...
 * @Copy: [ com.bjike ]
 */
public class VoucherPermissionVO {
    /**
     * id
     */
    private String id;
     ...
     * list返回的操作对象
     */
    private List<VoucherOperateVO> cusOperateVO;
    ...
    public List<VoucherOperateVO> getCusOperateVO() {
        return cusOperateVO;
    }

    public void setCusOperateVO(List<VoucherOperateVO> cusOperateVO) {
