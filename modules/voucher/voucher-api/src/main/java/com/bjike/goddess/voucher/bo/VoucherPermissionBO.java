 ...
 * @Copy: [ com.bjike ]
 */
public class VoucherPermissionBO extends BaseBO {
     ...
     * list返回的操作对象
     */
    private List<VoucherOperateBO> cusOperateBO;
    ...
    public List<VoucherOperateBO> getCusOperateBO() {
        return cusOperateBO;
    }

    public void setCusOperateBO(List<VoucherOperateBO> cusOperateBO) {
