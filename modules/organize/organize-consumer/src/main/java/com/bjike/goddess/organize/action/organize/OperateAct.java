...
public class OperateAct {
     ...
     */
    @PostMapping("v1/save")
    public Result save(@Validated(ADD.class) OperateTO to, BindingResult result) throws ActException {
        try {
    ...
    public Result update(@Validated(EDIT.class) OperateTO to, BindingResult result) throws ActException {
        try {
