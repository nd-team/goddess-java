 ...
 * @Copy: [ com.bjike ]
 */
public class PositionWorkDetailsA extends BaseTO {
     ...
     * 模快表数据
     */
    private List<ModuleA> moduleAList;

    /**
     * 模快长度
     */
    private Integer moduleLendth;
    ...
    public List<ModuleA> getModuleAList() {
        return moduleAList;
    }

    public void setModuleAList(List<ModuleA> moduleAList) {
        this.moduleAList = moduleAList;
    }

    public Integer getModuleLendth() {
        return moduleLendth;
    }

    public void setModuleLendth(Integer moduleLendth) {
        this.moduleLendth = moduleLendth;
    }
}