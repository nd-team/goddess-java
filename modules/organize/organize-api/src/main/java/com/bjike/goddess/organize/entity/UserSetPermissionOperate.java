 ...
 */
@Entity
@Table(name = "organize_usersetpermissionoperate")
public class UserSetPermissionOperate extends BaseEntity {
     ...
     * 客户权限id,一对多关系
     */
    @Column(name = "cuspermissionId",  columnDefinition = "VARCHAR(255)   COMMENT '用户权限id'")
