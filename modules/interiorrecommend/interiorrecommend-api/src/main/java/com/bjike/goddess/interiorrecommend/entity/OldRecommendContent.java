...
public class OldRecommendContent extends BaseEntity {
    ...
    private OldRecommendInfo recommendInfo;
    ...
    public OldRecommendInfo getRecommendInfo() {
        return recommendInfo;
    }

    public void setRecommendInfo(OldRecommendInfo recommendInfo) {
