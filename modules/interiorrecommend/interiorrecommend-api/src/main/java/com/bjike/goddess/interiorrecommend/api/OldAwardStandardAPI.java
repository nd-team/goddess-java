 ...
 * @Copy: [ com.bjike ]
 */
public interface OldAwardStandardAPI {
     ...
     * @return 推荐奖励要求
     */
    OldAwardStandardBO addModel(OldAwardStandardTO to) throws SerException;
     ...
     * @return 推荐奖励要求
     */
    OldAwardStandardBO editModel(OldAwardStandardTO to) throws SerException;
