 ...
 * @Copy: [ com.bjike ]
 */
public interface OldRecommendTypeAPI {
     ...
     * @return 推荐类型设定
     */
    OldRecommendTypeBO addModel(OldRecommendTypeTO to) throws SerException;
     ...
     * @return 推荐类型设定
     */
    OldRecommendTypeBO editModel(OldRecommendTypeTO to) throws SerException;
     ...
     * @param id
     */
    OldRecommendTypeBO findById(String id) throws SerException;
     ...
     * @param dto 查询条件
     */
    Long count(OldRecommendTypeDTO dto) throws SerException;
}