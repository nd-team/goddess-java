...
//		JapiClient.delete(true);
        ...
        JapiClient.setProjectJavaPath("modules/costdetail/costdetail-consumer");//主项目位置
        JapiClient.setActionReletivePath("com/bjike/goddess/costdetail/action/");//主项目action位置
        JapiClient.setIncludeProjectJavaPath(new String[]{//关联项目
                "modules/costdetail/costdetail-api",
