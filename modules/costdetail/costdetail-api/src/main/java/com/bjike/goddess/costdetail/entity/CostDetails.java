 ...
 */
@Entity
@Table(name = "costdetail_costdetails")
public class CostDetails extends BaseEntity {
     ...
     * 初期余额合计
     */
    @Column(name = "beginBalanceSum", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '初期余额合计'")
    private Double beginBalanceSum;

    /**
     * 初期余额十日
     */
    @Column(name = "beginBalanceTen", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '初期余额十日'")
    private Double beginBalanceTen;

    /**
     * 初期余额十五日
     */
    @Column(name = "beginBalanceFift", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '初期余额十五日'")
    private Double beginBalanceFift;

    /**
     * 初期余额二十日
     */
    @Column(name = "beginBalanceTwtenty", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '初期余额二十日'")
    private Double beginBalanceTwtenty;

    /**
     * 初期余额三十日
     */
    @Column(name = "beginBalanceThirty", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '初期余额三十日'")
    private Double beginBalanceThirty;

    /**
     * 营业成本合计
     */
    @Column(name = "operatingSum", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '营业成本合计'")
    private Double operatingSum;

    /**
     * 营业成本十日
     */
    @Column(name = "operatingTen", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '营业成本十日'")
    private Double operatingTen;

    /**
     * 营业成本十五日
     */
    @Column(name = "operatingFift", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '营业成本十五日'")
    private Double operatingFift;

    /**
     * 营业成本二十日
     */
    @Column(name = "operatingTwtenty", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '营业成本二十日'")
    private Double operatingTwtenty;

    /**
     * 营业成本三十日
     */
    @Column(name = "operatingThirty", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '营业成本三十日'")
     ...
     * 应交税金合计
     */
    @Column(name = "payableTaxSum", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '应交税金合计'")
    private Double payableTaxSum;

    /**
     * 应交税金十日
     */
    @Column(name = "payableTaxTen", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '应交税金十日'")
    private Double payableTaxTen;

    /**
     * 应交税金十五日
     */
    @Column(name = "payableTaxFift", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '应交税金十五日'")
    private Double payableTaxFift;

    /**
     * 应交税金二十日
     */
    @Column(name = "payableTaxTwtenty", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '应交税金二十日'")
    private Double payableTaxTwtenty;

    /**
     * 应交税金三十日
     */
    @Column(name = "payableTaxThirty", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '应交税金三十日'")
     ...
     * 预估应收账款合计
     */
    @Column(name = "forecastAccountSum", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '预估应收账款合计'")
    private Double forecastAccountSum;

    /**
     * 预估应收账款十日
     */
    @Column(name = "forecastAccountTen", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '预估应收账款十日'")
    private Double forecastAccountTen;

    /**
     * 预估应收账款十五日
     */
    @Column(name = "forecastAccountFift", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '预估应收账款十五日'")
    private Double forecastAccountFift;

    /**
     * 预估应收账款二十日
     */
    @Column(name = "forecastAccountTwtenty", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '预估应收账款二十日'")
    private Double forecastAccountTwtenty;

    /**
     * 预估应收账款三十日
     */
    @Column(name = "forecastAccountThirty", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '预估应收账款三十日'")
    private Double forecastAccountThirty;

    /**
     * 实际资金缺口合计
     */
    @Column(name = "actualGapSum", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '实际资金缺口合计'")
    private Double actualGapSum;

    /**
     * 实际资金缺口十日
     */
    @Column(name = "actualGapTen", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '实际资金缺口十日'")
    private Double actualGapTen;

    /**
     * 实际资金缺口十五日
     */
    @Column(name = "actualGapFift", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '实际资金缺口十五日'")
    private Double actualGapFift;

    /**
     * 实际资金缺口二十日
     */
    @Column(name = "actualGapTwtenty", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '实际资金缺口二十日'")
    private Double actualGapTwtenty;

    /**
     * 实际资金缺口三十日
     */
    @Column(name = "actualGapThirty", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '实际资金缺口三十日'")
    private Double actualGapThirty;

    /**
     * 按时回款预估结余资金合计
     */
    @Column(name = "forecastBalanceMoSum", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '按时回款预估结余资金合计'")
    private Double forecastBalanceMoSum;

    /**
     * 按时回款预估结余资金十日
     */
    @Column(name = "forecastBalanceMoGapTen", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '按时回款预估结余资金十日'")
    private Double forecastBalanceMoGapTen;

    /**
     * 按时回款预估结余资金十五日
     */
    @Column(name = "forecastBalanceMoGapFift", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '按时回款预估结余资金十五日'")
    private Double forecastBalanceMoGapFift;

    /**
     * 按时回款预估结余资金二十日
     */
    @Column(name = "forecastBalanceMoTwtenty", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '按时回款预估结余资金二十日'")
    private Double forecastBalanceMoTwtenty;

    /**
     * 按时回款预估结余资金三十日
     */
    @Column(name = "forecastBalanceMoThirty", nullable = false, columnDefinition = "DECIMAL(10,2)   COMMENT '按时回款预估结余资金三十日'")
