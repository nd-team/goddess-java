...
public class CostDetailsAddEditBO extends BaseBO{
     ...
     * 劳务成本明细list
     */
    private List<LaborCostDetailBO> laborCostDetailList;
     ...
     * 公司借入明细list
     */
    private List<CompanyBorrowedDetailBO> companyBorrowedDetailList;
     ...
     * 实收资本明细list
     */
    private List<PaidCapitalDetailBO> paidCapitalDetailList;
     ...
     * 公司借出明细list
     */
    private List<CompanyLendDetailBO> companyLendDetailList;
     ...
     * 主营业务收入明细list
     */
    private List<BusinessIncomeDetailBO> businessIncomeDetailList;
    ...
    public List<LaborCostDetailBO> getLaborCostDetailList() {
        return laborCostDetailList;
    }

    public void setLaborCostDetailList(List<LaborCostDetailBO> laborCostDetailList) {
        this.laborCostDetailList = laborCostDetailList;
    }

    public List<CompanyBorrowedDetailBO> getCompanyBorrowedDetailList() {
        return companyBorrowedDetailList;
    }

    public void setCompanyBorrowedDetailList(List<CompanyBorrowedDetailBO> companyBorrowedDetailList) {
        this.companyBorrowedDetailList = companyBorrowedDetailList;
    }

    public List<PaidCapitalDetailBO> getPaidCapitalDetailList() {
        return paidCapitalDetailList;
    }

    public void setPaidCapitalDetailList(List<PaidCapitalDetailBO> paidCapitalDetailList) {
        this.paidCapitalDetailList = paidCapitalDetailList;
    }

    public List<CompanyLendDetailBO> getCompanyLendDetailList() {
        return companyLendDetailList;
    }

    public void setCompanyLendDetailList(List<CompanyLendDetailBO> companyLendDetailList) {
        this.companyLendDetailList = companyLendDetailList;
    }

    public List<BusinessIncomeDetailBO> getBusinessIncomeDetailList() {
        return businessIncomeDetailList;
    }

    public void setBusinessIncomeDetailList(List<BusinessIncomeDetailBO> businessIncomeDetailList) {
