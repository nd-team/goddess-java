...
public class CostDetailsAddEditVO {
     ...
     * 劳务成本明细list
     */
    private List<LaborCostDetailVO> laborCostDetailList;
     ...
     * 公司借入明细list
     */
    private List<CompanyBorrowedDetailVO> companyBorrowedDetailList;
     ...
     * 实收资本明细list
     */
    private List<PaidCapitalDetailVO> paidCapitalDetailList;
     ...
     * 公司借出明细list
     */
    private List<CompanyLendDetailVO> companyLendDetailList;
     ...
     * 主营业务收入明细list
     */
    private List<BusinessIncomeDetailVO> businessIncomeDetailList;
    ...
    public List<LaborCostDetailVO> getLaborCostDetailList() {
        return laborCostDetailList;
    }

    public void setLaborCostDetailList(List<LaborCostDetailVO> laborCostDetailList) {
        this.laborCostDetailList = laborCostDetailList;
    }

    public List<CompanyBorrowedDetailVO> getCompanyBorrowedDetailList() {
        return companyBorrowedDetailList;
    }

    public void setCompanyBorrowedDetailList(List<CompanyBorrowedDetailVO> companyBorrowedDetailList) {
        this.companyBorrowedDetailList = companyBorrowedDetailList;
    }

    public List<PaidCapitalDetailVO> getPaidCapitalDetailList() {
        return paidCapitalDetailList;
    }

    public void setPaidCapitalDetailList(List<PaidCapitalDetailVO> paidCapitalDetailList) {
        this.paidCapitalDetailList = paidCapitalDetailList;
    }

    public List<CompanyLendDetailVO> getCompanyLendDetailList() {
        return companyLendDetailList;
    }

    public void setCompanyLendDetailList(List<CompanyLendDetailVO> companyLendDetailList) {
        this.companyLendDetailList = companyLendDetailList;
    }

    public List<BusinessIncomeDetailVO> getBusinessIncomeDetailList() {
        return businessIncomeDetailList;
    }

    public void setBusinessIncomeDetailList(List<BusinessIncomeDetailVO> businessIncomeDetailList) {
        this.businessIncomeDetailList = businessIncomeDetailList;
    }
}