 ...
 * @Copy: [ com.bjike ]
 */
public class CostDetailsAddReturnBO extends BaseTO {
     ...
     * 明细
     */
    private List<CostDetailsAddReturnBO> costDetailsAddReturnBOS;
    ...
    public List<CostDetailsAddReturnBO> getCostDetailsAddReturnBOS() {
        return costDetailsAddReturnBOS;
    }

    public void setCostDetailsAddReturnBOS(List<CostDetailsAddReturnBO> costDetailsAddReturnBOS) {
