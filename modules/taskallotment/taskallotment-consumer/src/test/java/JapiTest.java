...
//        JapiClient.delete(true);
        ...
        JapiClient.setProjectJavaPath("modules/taskallotment/taskallotment-consumer");//主项目位置
        JapiClient.setActionReletivePath("com/bjike/goddess/taskallotment/action");//主项目action位置
