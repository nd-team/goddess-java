...
public class AppEntityToScan extends EntityToScanImpl<AppRoot> {
    ...
    public String[] entityScan() {
        return new String[]{"com.bjike.goddess.archive.entity", "com.bjike.goddess.user.entity", "com.bjike.goddess.organize.entity", "com.bjike.goddess.staffentry.entity"};
    }
}
