...
/**
* 公司社保购买类型持久化接口, 继承基类可使用ｊｐａ命名查询
* @Author:			[ dengjunren ]
* @Date:			[  2017-04-12 11:08 ]
* @Description:	[ 公司社保购买类型持久化接口, 继承基类可使用ｊｐａ命名查询 ]
* @Version:		[ v1.0.0 ]
* @Copy:   		[ com.bjike ]
*/
public interface SocialSecurityTypeRep extends JpaRep<SocialSecurityType ,SocialSecurityTypeDTO> { 
