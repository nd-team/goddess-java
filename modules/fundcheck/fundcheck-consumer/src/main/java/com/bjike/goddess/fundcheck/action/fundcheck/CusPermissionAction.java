...
import com.bjike.goddess.fundcheck.api.CusPermissionAPI;
import com.bjike.goddess.fundcheck.bo.CusOperateBO;
...
import com.bjike.goddess.fundcheck.vo.CusOperateVO;
import com.bjike.goddess.fundcheck.vo.CusPermissionVO;
...
public class CusPermissionAction {
     ...
     * 列表总条数
     *
     * @param cusPermissionDTO 资金核对权限信息dto
     * @des 获取所有资金核对权限信息总条数
     * @version v1
     */
    @GetMapping("v1/count")
     ...
     * 编辑资金核对权限
     *
     * @param cusPermissionTO 资金核对权限基本信息数据bo
     * @return class CusPermissionVO
     * @des 编辑资金核对权限
     * @version v1
     */
