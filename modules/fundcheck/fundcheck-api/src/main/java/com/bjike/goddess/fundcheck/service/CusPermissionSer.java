...
import com.bjike.goddess.fundcheck.entity.CusPermission;
...
public interface CusPermissionSer extends Ser<CusPermission, CusPermissionDTO> {
     ...
     * 资金核对权限列表
     *
     * @param cusPermissionDTO 资金核对权限数据
     ...
     * 添加资金核对权限
     *
     * @param cusPermissionTO 资金核对权限数据
     * @return CusPermissionBO
     * @throws SerException
     */
    ...
    /**
     * 根据idFlag查询可以某种操作的资金核对权限
     *
     * @param idFlag 资金核对权限idFlag
     * @throws SerException
     */
