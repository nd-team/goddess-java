...
//                JapiClient.delete(true);
        ...
        JapiClient.setProjectJavaPath("modules/financedispatch/financedispatch-consumer");//主项目位置
        JapiClient.setActionReletivePath("com/bjike/goddess/financedispatch/action");//主项目action位置
        JapiClient.setIncludeProjectJavaPath(new String[]{//关联项目
                "modules/dispatchcar/dispatchcar-api",
                "modules/financedispatch/financedispatch-api",
                "common/common-api"
        });
