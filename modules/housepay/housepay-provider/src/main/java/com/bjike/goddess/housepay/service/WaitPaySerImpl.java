...
public class WaitPaySerImpl extends ServiceImpl<WaitPay, WaitPayDTO> implements WaitPaySer {
    ...
    public List<AreaCollectBO> collectArea(CollectAreaTO to) throws SerException {
        ...
        sb.append(" WHERE a.area IN (" + condition + ") and date BETWEEN '" + startTime + "' and '" + endTime + "'");
    ...
    public List<ProjectCollectBO> collectProject(CollectProjectTO to) throws SerException {
        ...
        sb.append(" FROM (SELECT concat(a.year,'-',if(a.month<=9,concat('0',a.month),a.month))as date,a.* FROM housepay_waitpay as a) as a ");
        sb.append(" WHERE a.project IN (" + condition + ") and date BETWEEN '" + startTime + "' and '" + endTime + "'");
    ...
    public Double calculate(WaitPayTO to) throws SerException {
        Double total = to.getRent() + to.getWater() + to.getEnergy() + to.getFee() + to.getOtherFee();
        return total;
    }
