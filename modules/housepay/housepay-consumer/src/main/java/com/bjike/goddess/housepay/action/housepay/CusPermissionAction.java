...
import com.bjike.goddess.housepay.api.CusPermissionAPI;
import com.bjike.goddess.housepay.bo.CusOperateBO;
...
import com.bjike.goddess.housepay.vo.CusOperateVO;
import com.bjike.goddess.housepay.vo.CusPermissionVO;
...
public class CusPermissionAction {
     ...
     * 列表总条数
     *
     * @param cusPermissionDTO 房屋费用资金准备与支付权限信息dto
     * @des 获取所有房屋费用资金准备与支付权限信息总条数
     * @version v1
     */
    @GetMapping("v1/count")
     ...
     * 一个房屋费用资金准备与支付权限
     *
     * @param id 房屋费用资金准备与支付权限信息id
     * @return class CusPermissionVO
     * @des 根据id获取所有房屋费用资金准备与支付权限信息
     * @version v1
     */
     ...
     * @param id 房屋费用资金准备与支付权限信息id
     * @return class CusPermissionVO
     * @des 根据id获取所有房屋费用资金准备与支付权限获取类型下对象
     * @version v1
     */
     ...
     * 编辑房屋费用资金准备与支付权限
     *
     * @param cusPermissionTO 房屋费用资金准备与支付权限基本信息数据bo
     * @return class CusPermissionVO
     * @des 编辑房屋费用资金准备与支付权限
     * @version v1
     */
