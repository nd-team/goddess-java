...
public class ProblemHandlingResultSerImpl extends ServiceImpl<ProblemHandlingResult, ProblemHandlingResultDTO> implements ProblemHandlingResultSer {
    ...
    public List<CollectBO> collect(String[] areas) throws SerException {
        ...
        sb.append(" MAX( CASE WHEN problemTypes='1' THEN problemTypeCounts END ) AS person, ");
        sb.append(" MAX( CASE WHEN problemTypes='2' THEN problemTypeCounts END ) AS progress, ");
        sb.append(" MAX( CASE WHEN problemTypes='3' THEN problemTypeCounts END ) AS deliver, ");
        sb.append(" MAX( CASE WHEN problemTypes='4' THEN problemTypeCounts END ) AS device FROM ");
        sb.append(" ( ");
        ...
        sb.append(" (SELECT area ,internalProjectName,externalContractProjectName, ");
        sb.append(" MAX( CASE WHEN problemEmergencyDegree='1' THEN problemEmergencyDegreeCounts END ) AS elementary, ");
        sb.append(" MAX( CASE WHEN problemEmergencyDegree='2' THEN problemEmergencyDegreeCounts END ) AS intermediate, ");
        sb.append(" MAX( CASE WHEN problemEmergencyDegree='3' THEN problemEmergencyDegreeCounts END ) AS emergency FROM ");
        sb.append(" ( ");
        ...
        sb.append(" (SELECT  area,internalProjectName,externalContractProjectName, ");
        sb.append(" MAX( CASE WHEN problemObject='1' THEN problemObjectCounts END ) AS operator, ");
        sb.append(" MAX( CASE WHEN problemObject='2' THEN problemObjectCounts END ) AS vender, ");
        sb.append(" MAX( CASE WHEN problemObject='3' THEN problemObjectCounts END ) AS intergrator, ");
        sb.append(" MAX( CASE WHEN problemObject='4' THEN problemObjectCounts END ) AS goverment , ");
        sb.append(" MAX( CASE WHEN problemObject='5' THEN problemObjectCounts END ) AS innerstaff FROM ");
        sb.append(" ( ");
        ...
        sb.append(" (SELECT area,internalProjectName,externalContractProjectName, ");
        sb.append(" MAX( CASE WHEN problemProcessingResult='1' THEN problemProcessingResultCounts END ) AS complete, ");
        sb.append(" MAX( CASE WHEN problemProcessingResult='2' THEN problemProcessingResultCounts END ) AS uncomplete FROM ");
        sb.append(" ( ");
