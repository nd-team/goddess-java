...
import com.bjike.goddess.projectissuehandle.api.CollectEmailAPI;
...
import com.bjike.goddess.projectissuehandle.vo.CollectEmailVO;
...
public class CollectEmailAction {
     ...
     * 列表总条数
     *
     * @param collectEmailDTO 项目中的问题受理和处理邮件信息dto
     * @des 获取所有项目中的问题受理和处理信息总条数
     * @version v1
     */
    @GetMapping("v1/count")
     ...
     * 一个项目中的问题受理和处理邮件
     *
     * @param id 项目中的问题受理和处理邮件信息id
     * @return class CollectEmailVO
     * @des 根据id获取项目中的问题受理和处理邮件信息
     * @version v1
     */
     ...
     * 项目中的问题受理和处理邮件汇总列表
     *
     * @param collectEmailDTO 项目中的问题受理和处理邮件汇总信息dto
     * @return class CollectEmailVO
     * @des 获取所有项目中的问题受理和处理邮件汇总信息
     * @version v1
     */
    @GetMapping("v1/list")
     ...
     * 添加项目中的问题受理和处理邮件汇总
     *
     * @param collectEmailTO 项目中的问题受理和处理邮件汇总基本信息数据to
     * @return class CollectEmailVO
     * @des 添加项目中的问题受理和处理邮件汇总
     * @version v1
     */
    @LoginAuth
    @PostMapping("v1/add")
     ...
     * 编辑项目中的问题受理和处理邮件汇总
     *
     * @param collectEmailTO 项目中的问题受理和处理邮件汇总基本信息数据bo
     * @return class CollectEmailVO
     * @des 添加项目中的问题受理和处理邮件汇总
     * @version v1
     */
    ...
    public Result collect(@RequestParam String[] areas) throws ActException {
        try {
            List<CollectVO> collectVOS = BeanTransform.copyProperties(
                    collectEmailAPI.collect(areas), CollectVO.class);
    ...
    public Result area() throws ActException {
        try {
            List<String> areaList = collectEmailAPI.getArea();
