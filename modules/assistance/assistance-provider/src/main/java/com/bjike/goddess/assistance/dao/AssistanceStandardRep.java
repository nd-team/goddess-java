...
/**
* 补助标准持久化接口, 继承基类可使用ｊｐａ命名查询
* @Author:			[ tanghaixiang ]
* @Date:			[  2017-04-13 09:29 ]
* @Description:	[ 补助标准持久化接口, 继承基类可使用ｊｐａ命名查询 ]
* @Version:		[ v1.0.0 ]
* @Copy:   		[ com.bjike ]
*/
public interface AssistanceStandardRep extends JpaRep<AssistanceStandard ,AssistanceStandardDTO> { 
