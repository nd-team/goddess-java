 ...
 * @Copy: [ com.bjike ]
 */
public interface MaterialStatusWeekSumAPI {
     ...
     * @throws SerException
     */
    MaterialStatusWeekSumBO findById(String id) throws SerException;
     ...
     * @throws SerException
     */
    Long count(MaterialStatusWeekSumDTO dto) throws SerException;
