 ...
 * @Copy: [ com.bjike ]
 */
public interface RepairStateMonthSumAPI {
     ...
     * @throws SerException
     */
    RepairStateMonthSumBO findById(String id) throws SerException;
     ...
     * @throws SerException
     */
    Long count(RepairStateMonthSumDTO dto) throws SerException;
