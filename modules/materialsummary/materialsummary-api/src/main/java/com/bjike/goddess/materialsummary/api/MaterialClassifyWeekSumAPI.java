 ...
 * @Copy: [ com.bjike ]
 */
public interface MaterialClassifyWeekSumAPI {
     ...
     * @throws SerException
     */
    MaterialClassifyWeekSumBO findById(String id) throws SerException;
     ...
     * @throws SerException
     */
    Long count(MaterialClassifyWeekSumDTO dto) throws SerException;
