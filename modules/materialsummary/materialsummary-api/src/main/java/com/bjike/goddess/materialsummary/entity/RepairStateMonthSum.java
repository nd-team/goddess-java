...
*/
@Entity
@Table(name = "materialsummary_repairstatemonthsum")
public class RepairStateMonthSum extends BaseEntity { 
...
* 维修状态
*/
@Column(name = "",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '维修状态'"  ) 
