...
*/
@Entity
@Table(name = "materialsummary_transfertypemonthsum")
public class TransferTypeMonthSum extends BaseEntity { 
...
* 物资类型
*/
@Column(name = "",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '物资类型'"  ) 
