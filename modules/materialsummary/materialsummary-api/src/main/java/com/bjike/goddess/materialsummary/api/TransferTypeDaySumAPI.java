 ...
 * @Copy: [ com.bjike ]
 */
public interface TransferTypeDaySumAPI {
     ...
     * @throws SerException
     */
    TransferTypeDaySumBO findById(String id) throws SerException;
     ...
     * @throws SerException
     */
    Long count(TransferTypeDaySumDTO dto) throws SerException;
