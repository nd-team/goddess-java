...
*/
@Entity
@Table(name = "materialsummary_instocksoruceweeksum")
public class InStockSoruceWeekSum extends BaseEntity { 
...
* 入库来源
*/
@Column(name = "",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '入库来源'"  ) 
