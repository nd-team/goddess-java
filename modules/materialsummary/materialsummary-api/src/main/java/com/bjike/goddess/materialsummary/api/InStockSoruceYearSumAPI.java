 ...
 * @Copy: [ com.bjike ]
 */
public interface InStockSoruceYearSumAPI {
     ...
     * @throws SerException
     */
    InStockSoruceYearSumBO findById(String id) throws SerException;
     ...
     * @throws SerException
     */
    Long count(InStockSoruceYearSumDTO dto) throws SerException;
