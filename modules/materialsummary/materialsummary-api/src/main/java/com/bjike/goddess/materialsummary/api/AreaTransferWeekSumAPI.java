 ...
 * @Copy: [ com.bjike ]
 */
public interface AreaTransferWeekSumAPI {
     ...
     * @throws SerException
     */
    AreaTransferWeekSumBO findById(String id) throws SerException;
     ...
     * @throws SerException
     */
    Long count(AreaTransferWeekSumDTO dto) throws SerException;
