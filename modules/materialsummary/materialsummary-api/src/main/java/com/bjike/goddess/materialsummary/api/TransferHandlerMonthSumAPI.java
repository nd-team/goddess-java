 ...
 * @Copy: [ com.bjike ]
 */
public interface TransferHandlerMonthSumAPI {
     ...
     * @throws SerException
     */
    TransferHandlerMonthSumBO findById(String id) throws SerException;
     ...
     * @throws SerException
     */
    Long count(TransferHandlerMonthSumDTO dto) throws SerException;
