 ...
 */
@Entity
@Table(name = "materialsummary_materialstatusmonthsum")
public class MaterialStatusMonthSum extends BaseEntity {
     ...
     * 物资状态
     */
    @Column(name = "instockState", nullable = false, columnDefinition = "TINYINT(2) COMMENT '物资状态'")
