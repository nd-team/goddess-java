 ...
 * @Copy: [ com.bjike ]
 */
public interface AreaBuyStatusWeekSumAPI {
     ...
     * @throws SerException
     */
    AreaBuyStatusWeekSumBO findById(String id) throws SerException;
     ...
     * @throws SerException
     */
    Long count(AreaBuyStatusWeekSumDTO dto) throws SerException;
