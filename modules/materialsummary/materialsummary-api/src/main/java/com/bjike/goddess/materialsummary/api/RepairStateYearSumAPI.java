 ...
 * @Copy: [ com.bjike ]
 */
public interface RepairStateYearSumAPI {
     ...
     * @throws SerException
     */
    RepairStateYearSumBO findById(String id) throws SerException;
     ...
     * @throws SerException
     */
    Long count(RepairStateYearSumDTO dto) throws SerException;
