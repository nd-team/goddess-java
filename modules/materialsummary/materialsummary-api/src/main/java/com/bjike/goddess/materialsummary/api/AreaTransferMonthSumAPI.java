 ...
 * @Copy: [ com.bjike ]
 */
public interface AreaTransferMonthSumAPI {
     ...
     * @throws SerException
     */
    AreaTransferMonthSumBO findById(String id) throws SerException;
     ...
     * @throws SerException
     */
    Long count(AreaTransferMonthSumDTO dto) throws SerException;
