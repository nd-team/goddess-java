 ...
 * @Copy: [ com.bjike ]
 */
public interface MaterialClassifyMonthSumAPI {
     ...
     * @throws SerException
     */
    MaterialClassifyMonthSumBO findById(String id) throws SerException;
     ...
     * @throws SerException
     */
    Long count(MaterialClassifyMonthSumDTO dto) throws SerException;
