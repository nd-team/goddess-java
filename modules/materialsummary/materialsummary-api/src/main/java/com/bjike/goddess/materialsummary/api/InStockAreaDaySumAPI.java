 ...
 * @Copy: [ com.bjike ]
 */
public interface InStockAreaDaySumAPI {
     ...
     * @throws SerException
     */
    InStockAreaDaySumBO findById(String id) throws SerException;
     ...
     * @throws SerException
     */
    Long count(InStockAreaDaySumDTO dto) throws SerException;
