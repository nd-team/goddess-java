 ...
 * @Description: [ 地区部门领用月汇总 ]
 * @Version: [ v1.0.0 ]
 * @Copy: [ com.bjike ]
 */
@Entity
@Table(name = "materialsummary_areadepartreceivemonthsum")
public class AreaDepartReceiveMonthSum extends BaseEntity {
     ...
     * 总数量
     */
    @Column(name = "totalQty", nullable = false, columnDefinition = "VARCHAR(255) COMMENT '总数量'")
