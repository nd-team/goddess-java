 ...
 * @Copy: [ com.bjike ]
 */
public interface AreaDepartReceiveYearSumAPI {
     ...
     * @throws SerException
     */
    AreaDepartReceiveYearSumBO findById(String id) throws SerException;
     ...
     * @throws SerException
     */
    Long count(AreaDepartReceiveYearSumDTO dto) throws SerException;
