 ...
 * @Copy: [ com.bjike ]
 */
public interface MaterialClassifyDaySumAPI {
     ...
     * @throws SerException
     */
    MaterialClassifyDaySumBO findById(String id) throws SerException;
     ...
     * @throws SerException
     */
    Long count(MaterialClassifyDaySumDTO dto) throws SerException;
