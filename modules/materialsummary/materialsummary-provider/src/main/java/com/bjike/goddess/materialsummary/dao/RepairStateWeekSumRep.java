...
/**
* 维修状态周汇总持久化接口, 继承基类可使用ｊｐａ命名查询
* @Author:			[ sunfengtao ]
* @Date:			[  2017-05-22 01:49 ]
* @Description:	[ 维修状态周汇总持久化接口, 继承基类可使用ｊｐａ命名查询 ]
* @Version:		[ v1.0.0 ]
* @Copy:   		[ com.bjike ]
*/
public interface RepairStateWeekSumRep extends JpaRep<RepairStateWeekSum ,RepairStateWeekSumDTO> { 
