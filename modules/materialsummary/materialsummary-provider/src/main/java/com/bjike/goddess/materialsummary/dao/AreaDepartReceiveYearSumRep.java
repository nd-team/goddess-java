...
/**
* 地区部门领用年汇总持久化接口, 继承基类可使用ｊｐａ命名查询
* @Author:			[ sunfengtao ]
* @Date:			[  2017-05-22 11:27 ]
* @Description:	[ 地区部门领用年汇总持久化接口, 继承基类可使用ｊｐａ命名查询 ]
* @Version:		[ v1.0.0 ]
* @Copy:   		[ com.bjike ]
*/
public interface AreaDepartReceiveYearSumRep extends JpaRep<AreaDepartReceiveYearSum ,AreaDepartReceiveYearSumDTO> { 
