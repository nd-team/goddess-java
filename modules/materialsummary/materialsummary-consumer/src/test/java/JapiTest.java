...
//		JapiClient.delete(true);
		...
		JapiClient.setProjectJavaPath("modules/materialsummary/materialsummary-consumer");//主项目位置
		JapiClient.setActionReletivePath("com/bjike/goddess/materialsummary/action/");//主项目action位置
