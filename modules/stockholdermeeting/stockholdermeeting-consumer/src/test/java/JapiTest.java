...
//        JapiClient.delete(true);
        ...
        JapiClient.setProjectJavaPath("modules/stockholdermeeting/stockholdermeeting-consumer");//主项目位置
        JapiClient.setActionReletivePath("com/bjike/goddess/stockholdermeeting/action");//主项目action位置
        JapiClient.setIncludeProjectJavaPath(new String[]{//关联项目
                "modules/stockholdermeeting/stockholdermeeting-api",
