...
public class JapiTest {
	...
	public static void main(String[] args) throws IOException {
		...
		JapiClient.setProjectJavaPath("modules/proearlymarketcost/proearlymarketcost-consumer");//主项目位置
		JapiClient.setActionReletivePath("com/bjike/goddess/proearlymarketcost/action");//主项目action位置
		JapiClient.setIncludeProjectJavaPath(new String[]{//关联项目
				"modules/proearlymarketcost/proearlymarketcost-api",
				"common/common-api"
		});
