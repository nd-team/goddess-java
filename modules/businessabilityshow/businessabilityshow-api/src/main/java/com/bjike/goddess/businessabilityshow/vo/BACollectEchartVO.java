package com.bjike.goddess.businessabilityshow.vo;

import com.bjike.goddess.businessabilityshow.bo.*;
 ...
 * @Description: [商业展示能力图形展示传数对象 ]
 * @Version: [1.0.0]
 * @Copy: [com.bjike]
 */
public class BACollectEchartVO {
    /**
     * 标题
     */
