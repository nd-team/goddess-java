package com.bjike.goddess.businessabilityshow.excel;
 ...
 * @Description: [ 商务能力表现层对象 ]
 * @Version: [ v1.0.0 ]
 * @Copy: [ com.bjike ]
 */
public class BusinessAbilityExport {

    /**
     * 用途类型
     */
    @ExcelHeader(name = "用途类型")
     ...
     * 公司英文名称
     */
    @ExcelHeader(name = "公司英文名称")
    private String companyEnglishName;

    /**
     * 公司官网网址
     */
    @ExcelHeader(name = "公司官网网址")
     ...
     * 公司地址
     */
    @ExcelHeader(name = "公司地址")
    private String companyAddress;

    /**
     * 公司注册地
     */
    @ExcelHeader(name = "公司注册地")
    private String companyRegisterAddress;

    /**
     * 公司注册资金
     */
    @ExcelHeader(name = "公司注册资金")
    private Double companyRegisterFunds;

    /**
     * 人员组成
     */
    @ExcelHeader(name = "人员组成")
