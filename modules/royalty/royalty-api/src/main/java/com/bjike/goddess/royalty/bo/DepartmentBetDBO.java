...
public class DepartmentBetDBO extends BaseBO {
     ...
     * 体系间对赌表E
     */
    private List<DepartmentBetEBO> departmentBetEBOS;
    ...
    public List<DepartmentBetEBO> getDepartmentBetEBOS() {
        return departmentBetEBOS;
    }

    public void setDepartmentBetEBOS(List<DepartmentBetEBO> departmentBetEBOS) {
