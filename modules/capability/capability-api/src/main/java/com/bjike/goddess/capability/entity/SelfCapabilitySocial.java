...
* 性别
*/
@Column(name = "sex",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '性别'"  ) 
 private String  sex; 
...
* 邮箱
*/
@Column(name = "emailName",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '邮箱'"  ) 
 private String  emailName; 

/**
* QQ/微信
*/
@Column(name = "qqOrWechat",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT 'QQ/微信'"  ) 
 private String  qqOrWechat; 

/**
* 籍贯
*/
@Column(name = "natives",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '籍贯'"  ) 
...
* 性格评价
*/
@Column(name = "charact",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '性格评价'"  ) 
 private String  charact; 

/**
* 家庭成员
*/
@Column(name = "family",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '家庭成员'"  ) 
 private String  family; 

/**
* 家庭成员与本人关系
*/
@Column(name = "familyRelation",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '家庭成员与本人关系'"  ) 
 private String  familyRelation; 

/**
* 求学和培训经历
*/
@Column(name = "studyExperience",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '求学和培训经历'"  ) 
 private String  studyExperience; 

/**
* 接触经历
*/
@Column(name = "connectExperience",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '接触经历'"  ) 
 private String  connectExperience; 

/**
* 以往工作地区
*/
@Column(name = "oldWorkPlace",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '以往工作地区'"  ) 
 private String  oldWorkPlace; 

/**
* 生活地区
*/
@Column(name = "livePlace",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '生活地区'"  ) 
 private String  livePlace; 

/**
* 成长地区
*/
@Column(name = "growthPlace",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '成长地区'"  ) 
 private String  growthPlace; 

/**
* 个人能力id
*/
@Column(name = "selfCapabilityId",nullable = false,columnDefinition = "VARCHAR(255)   COMMENT '个人能力id'"  ) 
