...
//        JapiClient.delete(true);
        ...
        JapiClient.setProjectJavaPath("modules/equipmentprepared/equipmentprepared-consumer");//主项目位置
        JapiClient.setActionReletivePath("com/bjike/goddess/equipmentprepared/action");//主项目action位置
        JapiClient.setIncludeProjectJavaPath(new String[]{//关联项目
                "modules/equipmentprepared/equipmentprepared-api",
                "common/common-api",
                "modules/materialbuy/materialbuy-api",
