 ...
 * @Copy: [ com.bjike ]
 */
public interface InterfaceCalculationDetailAPI {
    ...
    void add(InterfaceCalculationDetailTO interfaceCalculationDetailTO);
...
//    List<InterfaceCalculationDetailBO> search(String condition);
}