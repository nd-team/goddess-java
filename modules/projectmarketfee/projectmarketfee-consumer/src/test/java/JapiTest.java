...
//        JapiClient.delete(true);
        ...
        JapiClient.setProjectJavaPath("modules/projectmarketfee/projectmarketfee-consumer");//主项目位置
        JapiClient.setActionReletivePath("com/bjike/goddess/projectmarketfee/action");//主项目action位置
