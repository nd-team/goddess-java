 ...
 * @Description: [ 项目提成权重分配类型表 ]
 * @Version: [ v1.0.0 ]
 * @Copy: [ com.bjike ]
 */
@Entity
@Table(name = "projectroyalty_weightaltype")
public class WeightalType extends BaseEntity {

    /**
     * 项目提成权重分配表id
     */
    @Column(name = "weightalsId", nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '项目提成权重分配表id'")
     ...
     * 完工时间（月）
     */
    @Column(name = "", nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '完工时间（月）'")
