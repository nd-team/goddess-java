...
public class CommerceContactsAct extends BaseFileAction {
    ...
    public Result sonPermission() throws ActException {
        try {
            ...
            List<SonPermissionObject> hasPermissionList = commerceContactsAPI.sonPermission();
    ...
    public Result guidePermission(@Validated(GuidePermissionTO.TestAdd.class) GuidePermissionTO guidePermissionTO, BindingResult bindingResult, HttpServletRequest request) throws ActException {
        try {
            ...
            Boolean isHasPermission = commerceContactsAPI.guidePermission(guidePermissionTO);
            if (!isHasPermission) {
                //int code, String msg
