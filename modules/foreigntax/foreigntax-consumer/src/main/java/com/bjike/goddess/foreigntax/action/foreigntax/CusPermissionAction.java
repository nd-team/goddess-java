...
import com.bjike.goddess.foreigntax.api.CusPermissionAPI;
import com.bjike.goddess.foreigntax.bo.CusOperateBO;
...
import com.bjike.goddess.foreigntax.vo.CusOperateVO;
import com.bjike.goddess.foreigntax.vo.CusPermissionVO;
...
public class CusPermissionAction {
     ...
     * 列表总条数
     *
     * @param cusPermissionDTO 对外税务权限信息dto
     * @des 获取所有对外税务权限信息总条数
     * @version v1
     */
    @GetMapping("v1/count")
     ...
     * 编辑对外税务权限
     *
     * @param cusPermissionTO 对外税务权限基本信息数据bo
     * @return class CusPermissionVO
     * @des 编辑对外税务权限
     * @version v1
     */
