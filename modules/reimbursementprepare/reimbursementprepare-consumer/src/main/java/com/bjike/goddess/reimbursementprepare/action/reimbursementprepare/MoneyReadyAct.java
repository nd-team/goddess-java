...
import com.bjike.goddess.reimbursementprepare.api.MoneyReadyAPI;
...
import com.bjike.goddess.reimbursementprepare.vo.MoneyReadyCountVO;
import com.bjike.goddess.reimbursementprepare.vo.MoneyReadyVO;
...
public class MoneyReadyAct {
     ...
     * @version v1
     */
    @GetMapping("v1/countContrast")
    public Result countContrast(@Validated(MoneyReadyDTO.COUNT.class) MoneyReadyDTO dto, BindingResult result, HttpServletRequest request) throws ActException {
        try {
            List<MoneyReadyCountBO> list = moneyReadyAPI.countContrast(dto);
