...
//		JapiClient.delete(true);
		...
		JapiClient.setProjectJavaPath("modules/materialtransfer/materialtransfer-consumer");//主项目位置
		JapiClient.setActionReletivePath("com/bjike/goddess/materialtransfer/action");//主项目action位置
		JapiClient.setIncludeProjectJavaPath(new String[]{//关联项目
				"modules/materialtransfer/materialtransfer-api",
				"common/common-api"
		});
