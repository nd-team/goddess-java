...
import com.bjike.goddess.managepromotion.api.CusPermissionAPI;
import com.bjike.goddess.managepromotion.bo.CusOperateBO;
import com.bjike.goddess.managepromotion.bo.CusPermissionBO;
import com.bjike.goddess.managepromotion.dto.CusPermissionDTO;
import com.bjike.goddess.managepromotion.to.CusPermissionTO;
import com.bjike.goddess.managepromotion.vo.CusOperateVO;
import com.bjike.goddess.managepromotion.vo.CusPermissionVO;
...
public class CusPermissionAction {
     ...
     * 列表总条数
     *
     * @param cusPermissionDTO 技能晋升权限信息dto
     * @des 获取所有技能晋升权限信息总条数
     * @version v1
     */
    @GetMapping("v1/count")
     ...
     * 编辑技能晋升权限
     *
     * @param cusPermissionTO 技能晋升权限基本信息数据bo
     * @return class CusPermissionVO
     * @des 编辑技能晋升权限
     * @version v1
     */
