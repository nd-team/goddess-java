...
public class JapiTest {
	...
	public static void main(String[] args) throws IOException {
		...
		JapiClient.setProjectJavaPath("modules/managefee/managefee-consumer");//主项目位置
		JapiClient.setActionReletivePath("com/bjike/goddess/managefee/action");//主项目action位置
		JapiClient.setIncludeProjectJavaPath(new String[]{//关联项目
				"modules/managefee/managefee-api",
