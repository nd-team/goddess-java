 ...
 * @Copy: [ com.bjike ]
 */
public class PlanYearmapsBO extends BaseBO {
     ...
     * 金额类型集合
     */
    private List<PlanYearBusinessBO> planYearBusinessVOs;
    ...
    public List<PlanYearBusinessBO> getPlanYearBusinessVOs() {
        return planYearBusinessVOs;
    }

    public void setPlanYearBusinessVOs(List<PlanYearBusinessBO> planYearBusinessVOs) {
