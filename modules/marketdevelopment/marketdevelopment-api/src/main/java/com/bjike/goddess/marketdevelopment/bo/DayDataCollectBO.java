 ...
 * @Copy: [ com.bjike ]
 */
public class DayDataCollectBO extends BaseBO {
    ...
    List<BusinessDataBO> businessDataVOs;
    ...
    public List<BusinessDataBO> getBusinessDataVOs() {
        return businessDataVOs;
    }

    public void setBusinessDataVOs(List<BusinessDataBO> businessDataVOs) {
        this.businessDataVOs = businessDataVOs;
    }
}