 ...
 * @Copy: [ com.bjike ]
 */
public class PlanYearVO implements Serializable {
    /**
     * 更新时间
     */
    ...
    List<PlanYearType1VO> planYearTypeVOs;
    ...
    public List<PlanYearType1VO> getPlanYearTypeVOs() {
        return planYearTypeVOs;
    }

    public void setPlanYearTypeVOs(List<PlanYearType1VO> planYearTypeVOs) {
