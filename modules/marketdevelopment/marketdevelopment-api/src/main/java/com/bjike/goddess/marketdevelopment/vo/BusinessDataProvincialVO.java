 ...
 * @Copy: [ com.bjike ]
 */
public class BusinessDataProvincialVO extends BaseBO {
    ...
    private List<MonthSubjectProvincialVO> monthSubjectProvincialVOs;
    ...
    public List<MonthSubjectProvincialVO> getMonthSubjectProvincialVOs() {
        return monthSubjectProvincialVOs;
    }

    public void setMonthSubjectProvincialVOs(List<MonthSubjectProvincialVO> monthSubjectProvincialVOs) {
