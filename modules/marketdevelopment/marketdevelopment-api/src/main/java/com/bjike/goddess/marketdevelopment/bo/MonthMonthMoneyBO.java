 ...
 * @Copy: [ com.bjike ]
 */
public class MonthMonthMoneyBO extends BaseBO {
    ...
    List<MonthBusinessDataBO> monthBusinessDataVOs;
    ...
    public List<MonthBusinessDataBO> getMonthBusinessDataVOs() {
        return monthBusinessDataVOs;
    }

    public void setMonthBusinessDataVOs(List<MonthBusinessDataBO> monthBusinessDataVOs) {
