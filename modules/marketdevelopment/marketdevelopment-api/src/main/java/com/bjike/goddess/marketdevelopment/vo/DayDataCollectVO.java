 ...
 * @Copy: [ com.bjike ]
 */
public class DayDataCollectVO extends BaseBO {
    ...
    List<BusinessDataVO> businessDataVOs;
    ...
    public List<BusinessDataVO> getBusinessDataVOs() {
        return businessDataVOs;
    }

    public void setBusinessDataVOs(List<BusinessDataVO> businessDataVOs) {
