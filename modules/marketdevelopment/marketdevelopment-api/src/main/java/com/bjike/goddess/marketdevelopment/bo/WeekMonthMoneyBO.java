 ...
 * @Copy: [ com.bjike ]
 */
public class WeekMonthMoneyBO extends BaseBO {
    ...
    List<WeekBusinessDataBO> weekBusinessDataVOs;
    ...
    public List<WeekBusinessDataBO> getWeekBusinessDataVOs() {
        return weekBusinessDataVOs;
    }

    public void setWeekBusinessDataVOs(List<WeekBusinessDataBO> weekBusinessDataVOs) {
