 ...
 * @Copy: [ com.bjike ]
 */
public class WeekBusinessDataBO extends BaseBO {
    ...
    private List<WeekSubjectDataBO> weekSubjectDataVOs;
    ...
    public List<WeekSubjectDataBO> getWeekSubjectDataVOs() {
        return weekSubjectDataVOs;
    }

    public void setWeekSubjectDataVOs(List<WeekSubjectDataBO> weekSubjectDataVOs) {
