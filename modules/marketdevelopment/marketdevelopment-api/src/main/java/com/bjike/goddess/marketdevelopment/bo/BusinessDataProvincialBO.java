 ...
 * @Copy: [ com.bjike ]
 */
public class BusinessDataProvincialBO extends BaseBO {
    ...
    private List<MonthSubjectProvincialBO> monthSubjectProvincialVOs;
    ...
    public List<MonthSubjectProvincialBO> getMonthSubjectProvincialVOs() {
        return monthSubjectProvincialVOs;
    }

    public void setMonthSubjectProvincialVOs(List<MonthSubjectProvincialBO> monthSubjectProvincialVOs) {
        this.monthSubjectProvincialVOs = monthSubjectProvincialVOs;
    }
}