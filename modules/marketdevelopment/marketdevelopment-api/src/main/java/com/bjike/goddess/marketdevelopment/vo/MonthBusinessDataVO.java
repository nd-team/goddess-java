 ...
 * @Copy: [ com.bjike ]
 */
public class MonthBusinessDataVO extends BaseBO {
    ...
    private List<MonthSubjectDataVO> monthSubjectDataVOs;
    ...
    public List<MonthSubjectDataVO> getMonthSubjectDataVOs() {
        return monthSubjectDataVOs;
    }

    public void setMonthSubjectDataVOs(List<MonthSubjectDataVO> monthSubjectDataVOs) {
