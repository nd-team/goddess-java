 ...
 * @Copy: [ com.bjike ]
 */
public class BusinessDataBO extends BaseBO {
    ...
    private List<SubjectDataBO> subjectDataVOs;
    ...
    public List<SubjectDataBO> getSubjectDataVOs() {
        return subjectDataVOs;
    }

    public void setSubjectDataVOs(List<SubjectDataBO> subjectDataVOs) {
        this.subjectDataVOs = subjectDataVOs;
    }
}