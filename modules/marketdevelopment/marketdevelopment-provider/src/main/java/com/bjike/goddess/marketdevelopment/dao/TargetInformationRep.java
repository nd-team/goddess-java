...
/**
* 确定目标信息持久化接口, 继承基类可使用ｊｐａ命名查询
* @Author:			[ dengjunren ]
* @Date:			[  2017-03-22 07:12 ]
* @Description:	[ 确定目标信息持久化接口, 继承基类可使用ｊｐａ命名查询 ]
* @Version:		[ v1.0.0 ]
* @Copy:   		[ com.bjike ]
*/
public interface TargetInformationRep extends JpaRep<TargetInformation ,TargetInformationDTO> { 
