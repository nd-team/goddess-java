...
//        JapiClient.delete(true);
        ...
        JapiClient.setProjectJavaPath("modules/managementpromotion/managementpromotion-consumer");//主项目位置
        JapiClient.setActionReletivePath("com/bjike/goddess/managementpromotion/action");//主项目action位置
