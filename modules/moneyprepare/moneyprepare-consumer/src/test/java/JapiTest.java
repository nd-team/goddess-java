...
//		JapiClient.delete(true);
		...
		JapiClient.setProjectJavaPath("modules/moneyprepare/moneyprepare-consumer");//主项目位置
		JapiClient.setActionReletivePath("com/bjike/goddess/moneyprepare/action");//主项目action位置
		JapiClient.setIncludeProjectJavaPath(new String[]{//关联项目
				"modules/moneyprepare/moneyprepare-api",
