 ...
 * @Copy: [ com.bjike ]
 */
public class CallInfoTO extends BaseTO {
     ...
     * 合同单价
     */
    @NotNull(message = "合同单价不能为空",groups = {CallInfoTO.TestAdd.class, CallInfoTO.TestEdit.class})
    private Double price;

    /**
     * 合同规模
     */
    @NotBlank(message = "合同规模不能为空",groups = {CallInfoTO.TestAdd.class, CallInfoTO.TestEdit.class})
    private String size;

    /**
     * 是否签订合同
     */
    @NotNull(message = "是否签订合同不能为空",groups = {CallInfoTO.TestAdd.class, CallInfoTO.TestEdit.class})
    private Boolean signedContract;

    /**
     * 回款周期
     */
    @NotBlank(message = "回款周期不能为空",groups = {CallInfoTO.TestAdd.class, CallInfoTO.TestEdit.class})
    private String paybackPeriod;

    /**
     * 预估到账时间
     */
    @NotBlank(message = "预估到账时间不能为空",groups = {CallInfoTO.TestAdd.class, CallInfoTO.TestEdit.class})
    private String forecastArriveTime;

    /**
     * 承包商
     */
    @NotBlank(message = "承包商不能为空",groups = {CallInfoTO.TestAdd.class, CallInfoTO.TestEdit.class})
    private String contractor;

    /**
     * 难易程度
     */
    @NotBlank(message = "难易程度不能为空",groups = {CallInfoTO.TestAdd.class, CallInfoTO.TestEdit.class})
    private String complexity;

    /**
     * 预估利润率
     */
    @NotNull(message = "预估利润率不能为空",groups = {CallInfoTO.TestEdit.class})
    private Double forecastProfitMargin;

    /**
     * 资金方分配率
     */
    @NotNull(message = "资金方分配率不能为空",groups = {CallInfoTO.TestEdit.class})
     ...
     * 预估分配时间
     */
    @NotBlank(message = "预估分配时间不能为空",groups = {CallInfoTO.TestEdit.class})
    private String forecastAllotTime;

    /**
     * 提取风险准备金率
     */
    @NotNull(message = "提取风险准备金率不能为空",groups = {CallInfoTO.TestEdit.class})
    private Double extractRiskRserveRatio;

    /**
     * 筹资总额
     */
    @NotNull(message = "筹资总额不能为空",groups = {CallInfoTO.TestEdit.class})
    private Double totalFund;

    /**
     * 已筹资金额
     */
    @NotNull(message = "已筹资金额不能为空",groups = {CallInfoTO.TestEdit.class})
     ...
     * 投资人
     */
    @NotBlank(message = "投资人不能为空",groups = {CallInfoTO.TestApply.class})
    private String investor;

    /**
     * 投资对象
     */
    @NotBlank(message = "投资对象不能为空",groups = {CallInfoTO.TestApply.class})
    private String investObject;

    /**
     * 投资形式
     */
    @NotBlank(message = "投资形式不能为空",groups = {CallInfoTO.TestApply.class})
    private String investForm;

    /**
     * 投资总额
     */
    @NotNull(message = "投资总额不能为空",groups = {CallInfoTO.TestApply.class})
     ...
     * 投资日期
     */
    @NotBlank(message = "投资日期不能为空",groups = {CallInfoTO.TestApply.class})
    private String investDate;

    /**
     * 本次投资额
     */
    @NotNull(message = "本次投资额不能为空",groups = {CallInfoTO.TestApply.class})
