 ...
 */
@Entity
@Table(name = "moneyside_moneyexitapplywrongrecord")
public class MoneyExitApplyWrongRecord extends BaseEntity {
     ...
     * 是否通过
     */
    @Column(columnDefinition = "VARCHAR(255)   COMMENT '是否通过'")
