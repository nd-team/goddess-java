 ...
 * @Copy: [ com.bjike ]
 */
public class CapitalInvestTO extends BaseTO {
     ...
     * 预估到账金额
     */
    @NotNull(message = "预估到账金额不能为空",groups = {ADD.class, EDIT.class})
    private Double forecastArriveMoney;

    /**
     * 到账时间
     */
    @NotBlank(message = "到账时间不能为空",groups = {ADD.class, EDIT.class})
    private String arriveTime;

    /**
     * 到账金额
     */
    @NotNull(message = "到账金额不能为空",groups = {ADD.class, EDIT.class})
