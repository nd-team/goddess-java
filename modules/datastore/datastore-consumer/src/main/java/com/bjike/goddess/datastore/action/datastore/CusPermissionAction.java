...
import com.bjike.goddess.datastore.api.CusPermissionAPI;
import com.bjike.goddess.datastore.bo.CusOperateBO;
import com.bjike.goddess.datastore.bo.CusPermissionBO;
import com.bjike.goddess.datastore.dto.CusPermissionDTO;
import com.bjike.goddess.datastore.to.CusPermissionTO;
import com.bjike.goddess.datastore.vo.CusOperateVO;
import com.bjike.goddess.datastore.vo.CusPermissionVO;
...
public class CusPermissionAction {
     ...
     * 列表总条数
     *
     * @param cusPermissionDTO 数据存储权限信息dto
     * @des 获取所有数据存储权限信息总条数
     * @version v1
     */
    @GetMapping("v1/count")
     ...
     * 编辑数据存储权限
     *
     * @param cusPermissionTO 数据存储权限基本信息数据bo
     * @return class CusPermissionVO
     * @des 编辑数据存储权限
     * @version v1
     */
