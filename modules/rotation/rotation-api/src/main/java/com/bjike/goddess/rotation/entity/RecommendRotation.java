...
public class RecommendRotation extends BaseEntity {
    ...
    @JoinColumn(name = "applyLevel_id", nullable = false, columnDefinition = "VARCHAR(36)   COMMENT '举荐轮换等级'")
    private SubsidyStandard applyLevel;

    /**
     * 举荐原因
     */
    @Column(name = "reason", nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '举荐原因'")
    private String reason;

    /**
     * 举荐人
     */
    @Column(name = "recommend", nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '举荐人'")
    private String recommend;

    /**
     * 举荐时间
     */
    @Column(name = "recommendTime", nullable = false, columnDefinition = "DATE   COMMENT '举荐时间'")
