 ...
 */
@RestController
@RequestMapping("qualificationshandle")
public class QualificationsHandleAct {
    ...
    public Result getTotal() throws ActException {
        try {
            return ActResult.initialize(qualificationsHandleAPI.getTotal());
        } catch (SerException e) {
            throw new ActException(e.getMessage());
        }
    }
    ...
    public Result getById(@PathVariable String id) throws ActException {
        try {
            return ActResult.initialize(BeanTransform.copyProperties(qualificationsHandleAPI.getById(id), QualificationsHandleVO.class));
        } catch (SerException e) {
            throw new ActException(e.getMessage());
        }
    }
    ...
    public Result guidePermission(@Validated(GuidePermissionTO.TestAdd.class) GuidePermissionTO guidePermissionTO, BindingResult bindingResult, HttpServletRequest request) throws ActException {
        try {
            ...
            Boolean isHasPermission = qualificationsHandleAPI.guidePermission(guidePermissionTO);
            if (!isHasPermission) {
                //int code, String msg
