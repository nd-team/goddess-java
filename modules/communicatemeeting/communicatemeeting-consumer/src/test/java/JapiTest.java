...
//        JapiClient.delete(true);
        ...
        JapiClient.setProjectJavaPath("modules/communicatemeeting/communicatemeeting-consumer");//主项目位置
        JapiClient.setActionReletivePath("com/bjike/goddess/communicatemeeting/action");//主项目action位置
        JapiClient.setIncludeProjectJavaPath(new String[]{//关联项目
                "modules/communicatemeeting/communicatemeeting-api",
