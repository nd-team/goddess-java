...
import com.bjike.goddess.communicatemeeting.api.DesginAPI;
...
import com.bjike.goddess.communicatemeeting.vo.DesginVO;
...
public class DesginAct {
     ...
     * 交流会组织内容设计列表总条数
     *
     * @param dto 交流会组织内容设计dto
     * @des 获取所有交流会组织内容设计总条数
     * @version v1
     */
     ...
     * @version v1
     */
    @GetMapping("v1/findNumber/{meetingLevel}")
    public Result findNumber(@PathVariable String meetingLevel) throws ActException {
        try {
            String s = desginAPI.findNumber(meetingLevel);
