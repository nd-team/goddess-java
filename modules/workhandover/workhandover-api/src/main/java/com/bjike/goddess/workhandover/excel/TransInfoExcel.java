...
public class TransInfoExcel extends BaseEntity {
     ...
     * 交接人确认
     */
    @ExcelHeader(name = "交接人确认", notNull = true)
    private Boolean isHandoff;

    /**
     * 接手人确认
     */
    @ExcelHeader(name = "接手人确认", notNull = true)
    private Boolean isTaskOver;

    /**
     * 负责人审核确认
     */
    @ExcelHeader(name = "负责人审核确认", notNull = true)
