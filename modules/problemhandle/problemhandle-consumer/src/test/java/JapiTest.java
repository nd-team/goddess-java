...
//        JapiClient.delete(true);
        ...
        JapiClient.setProjectJavaPath(
                "modules/problemhandle/problemhandle-consumer");//主项目位置
        JapiClient.setActionReletivePath("com/bjike/goddess/problemhandle/action");//主项目action位置
        JapiClient.setIncludeProjectJavaPath(new String[]{//关联项目
                "modules/problemhandle/problemhandle-api",
