...
import com.bjike.goddess.employeecontract.api.CusPermissionAPI;
import com.bjike.goddess.employeecontract.bo.CusOperateBO;
import com.bjike.goddess.employeecontract.bo.CusPermissionBO;
import com.bjike.goddess.employeecontract.dto.CusPermissionDTO;
import com.bjike.goddess.employeecontract.to.CusPermissionTO;
import com.bjike.goddess.employeecontract.vo.CusOperateVO;
import com.bjike.goddess.employeecontract.vo.CusPermissionVO;
...
public class CusPermissionAct {
     ...
     */
    @GetMapping("v1/count")
    public Result count(CusPermissionDTO dto) throws ActException {
        try {
            Long count = cusPermissionAPI.countPermission(dto);
     ...
     */
    @GetMapping("v1/list")
    public Result findListCusPermission(CusPermissionDTO dto, BindingResult bindingResult, HttpServletRequest request) throws ActException {
        try {
            List<CusPermissionBO> boList = cusPermissionAPI.list(dto);
    ...
    @LoginAuth
    @PutMapping("v1/edit")
    public Result editCusPermission(@Validated CusPermissionTO to) throws ActException {
        try {
            CusPermissionBO cusPermissionBO1 = cusPermissionAPI.edit(to);
