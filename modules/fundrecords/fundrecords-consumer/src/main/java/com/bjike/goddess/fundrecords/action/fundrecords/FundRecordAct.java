...
public class FundRecordAct extends BaseFileAction {
     ...
     * @param endTime 结束时间
     * @return class FundRecordCollectVO
     * @version v1
     */
    @GetMapping("v1/monthColl")
    public Result monthColl(@RequestParam String startTime, @RequestParam String endTime) throws ActException {
        try {
            List<FundRecordCollectVO> vo = BeanTransform.copyProperties(fundRecordAPI.monthSumma(startTime, endTime), FundRecordCollectVO.class);
            return ActResult.initialize(vo);
        } catch (SerException e) {
            throw new ActException("出现异常: " +e.getMessage());
        }
    }
    ...
    public Result areaSumma(@RequestParam String startTime, @RequestParam String endTime, @RequestParam String area) throws ActException {
        try {
            List<ConditionCollectVO> vo = BeanTransform.copyProperties(fundRecordAPI.areaSumma(startTime, endTime, area), ConditionCollectVO.class);
            return ActResult.initialize(vo);
        } catch (SerException e) {
            throw new ActException(e.getMessage());
        }
    ...
    public Result projectSumma(@RequestParam String startTime, @RequestParam String endTime, @RequestParam String projectGroup) throws ActException {
        try {
            List<ConditionCollectVO> vo = BeanTransform.copyProperties(fundRecordAPI.projectSumma(startTime, endTime, projectGroup), ConditionCollectVO.class);
            return ActResult.initialize(vo);
        } catch (SerException e) {
            throw new ActException(e.getMessage());
        }
    ...
    public Result projectNameSumma(@RequestParam String startTime, @RequestParam String endTime, @RequestParam String projectName) throws ActException {
        try {
            List<ConditionCollectVO> vo = BeanTransform.copyProperties(fundRecordAPI.projectNameSumma(startTime, endTime, projectName), ConditionCollectVO.class);
            return ActResult.initialize(vo);
        } catch (SerException e) {
            throw new ActException(e.getMessage());
        }
    ...
    public Result areaAnalysis(@RequestParam String startTime, @RequestParam String endTime, @RequestParam String area, HttpServletRequest request) throws ActException {
        try {
            List<AreaAnalyzeVO> voList = BeanTransform.copyProperties(fundRecordAPI.areaAnalysis(startTime, endTime, area), AreaAnalyzeVO.class, request);
            return ActResult.initialize(voList);
        } catch (SerException e) {
            throw new ActException(e.getMessage());
        }
    ...
    public Result projectAnalysis(@RequestParam String startTime, @RequestParam String endTime, @RequestParam String group, HttpServletRequest request) throws ActException {
        try {
            List<GroupAnalyzeVO> vo = BeanTransform.copyProperties(fundRecordAPI.projectAnalysis(startTime, endTime, group), GroupAnalyzeVO.class, request);
            return ActResult.initialize(vo);
        } catch (SerException e) {
            throw new ActException(e.getMessage());
        }
    ...
    public Result projectNameAnalysis(@RequestParam String startTime, @RequestParam String endTime, @RequestParam String project, HttpServletRequest request) throws ActException {
        try {
            List<ProjectAnalyzeVO> vo = BeanTransform.copyProperties(fundRecordAPI.projectNameAnalysis(startTime, endTime, project), ProjectAnalyzeVO.class, request);
            return ActResult.initialize(vo);
        } catch (SerException e) {
            throw new ActException(e.getMessage());
        }
    ...
    public Result listAll(FundRecordDTO dto)throws ActException{
        List<FundRecordVO> listVO= null;
        try {
            listVO = BeanTransform.copyProperties(fundRecordAPI.allFundRecord(dto),FundRecordVO.class);
    ...
    @PostMapping("v1/monthSummaExportE1xcel")
    public Result monthSummaExportE1xcel(String startTime, String endTime, HttpServletResponse response) throws ActException {
        try {
            String fileName = "日期汇总.xlsx";
            super.writeOutFile(response,fundRecordAPI.monthSummaExportE1xcel(startTime,endTime),fileName);
            return new ActResult("导出成功");
        } catch (SerException e) {
            throw new ActException(e.getMessage());
        } catch (IOException e1) {
    ...
    @PostMapping("v1/areaSummaExportExcel")
    public Result areaSummaExportExcel(String startTime, String endTime,String area, HttpServletResponse response) throws ActException {
        try {
            String fileName = "地区汇总.xlsx";
            super.writeOutFile(response,fundRecordAPI.areaSummaExportExcel(startTime,endTime,area),fileName);
            return new ActResult("导出成功");
        } catch (SerException e) {
            throw new ActException(e.getMessage());
        } catch (IOException e1) {
    ...
    @PostMapping("v1/projectSummaExportExcel")
    public Result projectSummaExportExcel(String startTime, String endTime,String projecta, HttpServletResponse response) throws ActException {
        try {
            String fileName = "项目组汇总.xlsx";
            super.writeOutFile(response,fundRecordAPI.projectSummaExportExcel(startTime,endTime,projecta),fileName);
            return new ActResult("导出成功");
        } catch (SerException e) {
            throw new ActException(e.getMessage());
        } catch (IOException e1) {
    ...
    @PostMapping("v1/projectNameSummaExportExcel")
    public Result projectNameSummaExportExcel(String startTime, String endTime,String projectName,HttpServletResponse response) throws ActException {
        try {
            String fileName = "项目汇总.xlsx";
            super.writeOutFile(response,fundRecordAPI.projectNameSummaExportExcel(startTime,endTime,projectName),fileName);
            return new ActResult("导出成功");
        } catch (SerException e) {
            throw new ActException(e.getMessage());
        } catch (IOException e1) {
