...
public interface PayTaxSer extends Ser<PayTax, PayTaxDTO> {
     ...
     * @return class PayTaxBO
     */
    default List<PayTaxBO> listPayTax(PayTaxDTO payTaxDTO) throws SerException {return null;}
    /**
     *  添加
     * @param payTaxTO 应交税金信息
     * @return class PayTaxBO
     */
    default PayTaxBO addPayTax(PayTaxTO payTaxTO) throws SerException { return null;}
     ...
     * @return class PayTaxBO
     */
    default PayTaxBO editPayTax(PayTaxTO payTaxTO) throws SerException { return null;}

    /**
     * 删除
     * @param id id
     */
    default void deletePayTax(String id ) throws SerException {return;};
     ...
     * @return class PayTaxBO
     */
    default PayTaxBO splitTax(PayTaxTO payTaxTO) throws SerException { return null;}
