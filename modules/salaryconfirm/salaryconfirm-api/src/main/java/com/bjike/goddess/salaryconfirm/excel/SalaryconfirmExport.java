 ...
 * @Copy: [ com.bjike ]
 */
public class SalaryconfirmExport extends BaseBO {
     ...
     * 计薪周期开始时间
     */
    @ExcelHeader(name = "计薪周期开始时间")
    private String salaryStart;

    /**
     * 计薪周期结束时间
     */
    @ExcelHeader(name = "计薪周期结束时间")
     ...
     * 出勤天数
     */
    @ExcelHeader(name = "出勤天数")
    private Double attendanceDays;

    /**
     * 员工工资
     */
    @ExcelHeader(name = "员工工资")
    private Double salary;

    /**
     * 电脑补助
     */
    @ExcelHeader(name = "电脑补助")
    private Double cpSubsidy;

    /**
     * 住宿补助
     */
    @ExcelHeader(name = "住宿补助")
    private Double dormitorySubsidy;

    /**
     * 工龄补助
     */
    @ExcelHeader(name = "工龄补助")
    private Double yearSubsidy;

    /**
     * 高温补助
     */
    @ExcelHeader(name = "高温补助")
    private Double hotSubsidy;

    /**
     * 社保补助
     */
    @ExcelHeader(name = "社保补助")
     ...
     * 本月需缴发票金额
     */
    @ExcelHeader(name = "本月需缴发票金额")
    private Double needRatepaying;

    /**
     * 累计需缴纳发票金额
     */
    @ExcelHeader(name = "累计需缴纳发票金额")
    private Double totalRatepayed;

    /**
     * 累计上交发票金额
     */
    @ExcelHeader(name = "累计上交发票金额")
    ...
    public String getFirstConfirm() {
        return firstConfirm;
    }

    public void setFirstConfirm(String firstConfirm) {
    ...
    //地区汇总对象
    public SalaryconfirmExport(String type, Integer year, Integer month, Double salary,
