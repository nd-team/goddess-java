 ...
 */
@Entity
@Table(name = "lendreimbursement_auditingbyreim")
public class AuditingByReim extends BaseEntity {
     ...
     * 是否通过
     */
    @Column(name = "", nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '是否通过'")
    private boolean pass;

    /**
     * 报销金额
     */
    @Column(name = "", nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '报销金额'")
    private double reimbursement;

    /**
     * 回退金额
     */
    @Column(name = "", nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '回退金额'")
    private double sendBack;

    /**
     * 借款金额
     */
    @Column(name = "", nullable = false, columnDefinition = "VARCHAR(255)   COMMENT '借款金额'")
