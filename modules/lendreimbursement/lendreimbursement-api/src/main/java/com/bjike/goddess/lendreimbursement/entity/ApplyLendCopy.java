 ...
 */
@Entity
@Table(name = "lendreimbursement_applylendcopy")
public class ApplyLendCopy extends BaseEntity {
     ...
     * 原id
     */
    @Column(name = "applyLendId",  nullable = false ,columnDefinition = "VARCHAR(255)   COMMENT '原id'")
