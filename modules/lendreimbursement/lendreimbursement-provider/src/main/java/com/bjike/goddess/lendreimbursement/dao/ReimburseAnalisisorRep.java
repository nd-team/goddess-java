...
/**
* 报销分析人员表持久化接口, 继承基类可使用ｊｐａ命名查询
* @Author:			[ tanghaixiang ]
* @Date:			[  2017-04-11 05:51 ]
* @Description:	[ 报销分析人员表持久化接口, 继承基类可使用ｊｐａ命名查询 ]
* @Version:		[ v1.0.0 ]
* @Copy:   		[ com.bjike ]
*/
public interface ReimburseAnalisisorRep extends JpaRep<ReimburseAnalisisor ,ReimburseAnalisisorDTO> { 
