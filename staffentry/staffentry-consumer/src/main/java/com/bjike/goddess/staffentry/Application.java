package com.bjike.goddess.staffentry;
...
@ComponentScan(basePackages = {"com.bjike.goddess.staffentry.action","com.bjike.goddess.common.consumer"},
...
public class Application {
	...
	public static void japi(){
		...
		JapiClient.setProjectJavaPath("staffentry/staffentry-consumer");//主项目位置
		JapiClient.setActionReletivePath("com/bjike/goddess/staffentry/action");//主项目action位置
		JapiClient.setIncludeProjectJavaPath(new String[]{//关联项目
				"staffentry/staffentry-api",
				"user/user-api",
				"common/common-api"
		});
