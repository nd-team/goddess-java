...
public class EntryRegisterBO extends BaseBO {
    ...
    public void setFamilyMemberBOList(List<FamilyMemberBO> familyMemberBOList) {
        this.familyMemberBOList = familyMemberBOList;
    }

    public List<StudyExperienceBO> getStudyExperienceBOList() {
        return studyExperienceBOList;
    }

    public void setStudyExperienceBOList(List<StudyExperienceBO> studyExperienceBOList) {
        this.studyExperienceBOList = studyExperienceBOList;
    }

    public List<WorkExperienceBO> getWorkExperienceBOList() {
        return workExperienceBOList;
    }

    public void setWorkExperienceBOList(List<WorkExperienceBO> workExperienceBOList) {
        this.workExperienceBOList = workExperienceBOList;
    }

    public List<CredentialBO> getCredentialBOList() {
        return credentialBOList;
    }

    public void setCredentialBOList(List<CredentialBO> credentialBOList) {
