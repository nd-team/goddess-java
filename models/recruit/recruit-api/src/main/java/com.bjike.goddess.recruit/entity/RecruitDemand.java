...
public class RecruitDemand extends BaseEntity {
     ...
     * 项目经理审核
     */
    @Column(columnDefinition = "TINYINT(1) DEFAULT 0 COMMENT '项目经理审核'", insertable = false)
    private AuditType pmAudit;

    /**
     * 商务审核
     */
    @Column(columnDefinition = "TINYINT(1) DEFAULT 0 COMMENT '商务审核'", insertable = false)
    private AuditType commerceAudit;

    /**
     * 总经办审核
     */
    @Column(columnDefinition = "TINYINT(1) DEFAULT 0 COMMENT '总经办审核'", insertable = false)
     ...
     * 是否完成招聘
     */
    @Column(columnDefinition = "BIT(1) DEFAULT 0 COMMENT '是否完成招聘'")
