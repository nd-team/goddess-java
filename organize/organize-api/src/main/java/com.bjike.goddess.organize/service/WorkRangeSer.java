...
public interface WorkRangeSer extends Ser<WorkRange, WorkRangeDTO> {
     ...
     * @throws SerException
     */
    default List<DepartmentWorkRangeBO> findDepartmentWorkRangeView(WorkRangeDTO dto) throws SerException {
        return null;
    }
     ...
     * @throws SerException
     */
    void departmentAddRange(String departmentId, String[] rangeIds) throws SerException;
