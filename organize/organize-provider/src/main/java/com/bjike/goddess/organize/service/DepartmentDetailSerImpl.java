...
//        bo.setDepartment(department.getName());
    ...
    public DepartmentDetailBO save(DepartmentDetailTO to) throws SerException {
        ...
        dto.getConditions().add(Restrict.eq(ID, to.getHierarchy_id()));
        Hierarchy hierarchy = hierarchySer.findOne(dto);
        department.setHierarchy(hierarchy);
        department.setDepartment_id(to.getDepartment_id());
